window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		*/
		...
		const css = ".DIJyPq_root{min-width:0;height:100%;color:var(--dsw-alias-label-primary,#1f2328);flex-direction:column;display:flex;position:relative;container-type:inline-size}.DIJyPq_head{flex-direction:column;gap:12px;padding:4px 4px 6px;display:flex}.DIJyPq_title{margin:0;font-size:16px;font-weight:500;line-height:24px}.DIJyPq_sub{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:8px;margin:0;font-size:12px;line-height:18px;display:flex}.DIJyPq_submitLink{color:var(--dsw-alias-label-tertiary,#8b93a1);white-space:nowrap;font-size:11px;line-height:18px;text-decoration:none}.DIJyPq_submitLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.DIJyPq_tabs{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-end;gap:2px;display:flex}.DIJyPq_tab{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-bottom:2px solid #0000;padding:7px 12px;font-size:13px}.DIJyPq_tab.DIJyPq_on{color:var(--dsw-alias-brand-primary,#4f6ef7);border-bottom-color:var(--dsw-alias-brand-primary,#4f6ef7);font-weight:600}.DIJyPq_subTabs{align-items:flex-end;gap:2px;margin:-4px 0 4px;display:flex}.DIJyPq_banner{background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;align-items:center;gap:8px;margin:0;padding:8px 12px;font-size:12px;display:flex}.DIJyPq_bannerIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0}.DIJyPq_bannerHint{color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:help;display:inline-flex}.DIJyPq_body{overflow-anchor:none;flex:1;padding:12px 4px 24px;overflow-x:hidden;overflow-y:auto}.DIJyPq_stickyHead{z-index:5;background:var(--dsw-alias-bg-layer-2,#f7f8fa);position:sticky;top:-1px}.DIJyPq_stickyHead:before{content:\"\";background:inherit;pointer-events:none;height:14px;position:absolute;bottom:100%;left:0;right:0}.DIJyPq_cats{margin:0 -4px 2px;padding:12px 4px 4px}.DIJyPq_catsRow{align-items:flex-start;gap:8px;display:flex;position:relative}.DIJyPq_star{color:var(--dsw-alias-label-secondary,#9ca3af);white-space:nowrap;flex:none;font-size:11px}.DIJyPq_top{z-index:20;display:inline-flex;position:absolute;bottom:18px;right:18px}.DIJyPq_topBtn{border-radius:99px;width:38px;height:38px;padding:0}.DIJyPq_tag{border:1px solid var(--dsw-alias-border-l3,#d9dde3);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:4px;flex-shrink:0;padding:1px 6px;font-size:11px;line-height:16px}.DIJyPq_okState{color:var(--dsw-alias-state-success-primary,#16a34a);white-space:nowrap;font-size:12px;font-weight:600}.DIJyPq_catsWrap{flex-wrap:wrap;flex:1;align-items:center;gap:6px;min-width:0;display:flex}.DIJyPq_catsCollapsed{max-height:62px;overflow:hidden}.DIJyPq_catsToggle.DIJyPq_catsToggle{height:26px;min-height:26px;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.DIJyPq_shots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:8px;margin:6px 0 8px;padding:2px 0 6px;display:flex;overflow-x:auto}.DIJyPq_shot{object-fit:cover;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:220px;height:150px}.DIJyPq_cardShots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:6px;margin:0 0 6px;padding:0 0 2px;display:flex;overflow-x:auto}.DIJyPq_cardShot{object-fit:contain;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:132px;height:88px;display:block}.DIJyPq_lightbox{z-index:10000;cursor:zoom-out;background:#000000d9;justify-content:center;align-items:center;display:flex;position:fixed;top:0;bottom:0;left:0;right:0}.DIJyPq_lightboxImg{object-fit:contain;cursor:default;border-radius:4px;max-width:90vw;max-height:85vh}.DIJyPq_lightboxClose{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:36px;height:36px;font-size:22px;line-height:1;display:grid;position:absolute;top:16px;right:16px}.DIJyPq_lightboxClose:hover{background:#ffffff38}.DIJyPq_lightboxNav{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:44px;height:44px;display:grid;position:absolute;top:50%;transform:translateY(-50%)}.DIJyPq_lightboxNav:hover{background:#ffffff38}.DIJyPq_lightboxPrev{left:16px}.DIJyPq_lightboxNext{right:16px}.DIJyPq_lightboxDots{gap:8px;display:flex;position:absolute;bottom:20px;left:50%;transform:translate(-50%)}.DIJyPq_lightboxDot{cursor:pointer;background:#fff6;border-radius:99px;width:7px;height:7px}.DIJyPq_lightboxDotOn{background:#fff}.DIJyPq_cmd{background:var(--dsw-alias-bg-layer-2,#f3f4f6);word-break:break-all;border-radius:6px;margin:8px 0 0;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:18px}.DIJyPq_warnLine{color:var(--dsw-alias-state-warn-primary,#b45309);flex-wrap:wrap;align-items:center;gap:4px;margin:0;font-size:12px;font-weight:600;line-height:18px;display:flex}.DIJyPq_modalNote{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:4px;margin:12px 0 0;font-size:12px;line-height:18px;display:flex}.DIJyPq_grid{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;display:grid}.DIJyPq_masonry{align-items:flex-start;gap:10px;display:flex}.DIJyPq_masonryCol{flex-direction:column;flex:1;gap:10px;min-width:0;display:flex}.DIJyPq_masonry>.DIJyPq_masonryCol>*{align-self:stretch;min-width:0}@media (max-width:680px){.DIJyPq_masonry{flex-direction:column}.DIJyPq_masonryCol{width:100%}.DIJyPq_grid{grid-template-columns:minmax(0,1fr)}}.DIJyPq_swatches{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;gap:0;height:34px;display:flex;overflow:hidden}.DIJyPq_themesGrid{margin-bottom:12px}.DIJyPq_swatches i{flex:1}.DIJyPq_themeToolbar{grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:8px;padding:0 4px 12px;display:grid}.DIJyPq_themeSearch{box-sizing:border-box;width:100%;min-width:0}.DIJyPq_themeToolbarActions{justify-content:flex-end;align-items:center;gap:8px;display:flex}.DIJyPq_themeFullscreenBtn.DIJyPq_themeFullscreenBtn{width:28px;min-width:28px;padding:0}.DIJyPq_themeResultBar{min-height:24px;color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;padding:0 4px 8px;font-size:12px;line-height:18px;display:flex}.DIJyPq_themeGallery{grid-template-columns:repeat(4,minmax(0,1fr));align-items:stretch;gap:10px;display:grid}.DIJyPq_themeCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);border-radius:8px;flex-direction:column;min-width:0;transition:border-color .16s cubic-bezier(.16,1,.3,1),box-shadow .16s cubic-bezier(.16,1,.3,1),transform .16s cubic-bezier(.16,1,.3,1);display:flex;overflow:hidden}.DIJyPq_themeCard:hover{border-color:var(--dsw-alias-border-l3,#d9dde3);box-shadow:var(--dsw-shadow-lv1,0 4px 12px #1f232814);transform:translateY(-1px)}.DIJyPq_themeCover{aspect-ratio:16/10;border:0;border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;color:var(--dsw-alias-label-secondary,#6b7280);cursor:zoom-in;border-radius:0;padding:0;display:block;position:relative;overflow:hidden}.DIJyPq_themeCover img{object-fit:contain;background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;height:100%;transition:transform .18s cubic-bezier(.16,1,.3,1);display:block}.DIJyPq_themeCover:hover img{transform:scale(1.012)}.DIJyPq_themeCover:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4f6ef7);outline-offset:-3px}.DIJyPq_themeCoverEmpty{cursor:default;color:var(--dsw-alias-label-tertiary,#8b93a1);flex-direction:column;justify-content:center;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.DIJyPq_themePreviewAction,.DIJyPq_themePreviewCount{color:#fff;-webkit-backdrop-filter:blur(8px);background:#14181fc7;border:1px solid #ffffff57;border-radius:4px;align-items:center;height:24px;padding:0 8px;font-size:11px;line-height:16px;display:inline-flex;position:absolute;bottom:8px}.DIJyPq_themePreviewAction{gap:4px;right:8px}.DIJyPq_themePreviewCount{left:8px}.DIJyPq_themeCardBody{flex-direction:column;flex:1;gap:8px;padding:12px;display:flex}.DIJyPq_themeCardHead{align-items:flex-start;gap:8px;min-width:0;display:flex}.DIJyPq_themeIdentity{flex:1;min-width:0}.DIJyPq_themeStatus,.DIJyPq_themeStatusMuted{white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:22px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.DIJyPq_themeStatus{background:var(--dsw-alias-state-success-tertiary,#16a34a1a);color:var(--dsw-alias-state-success-primary,#15803d)}.DIJyPq_themeStatusMuted{background:var(--dsw-alias-bg-layer-2,#f3f4f6);color:var(--dsw-alias-label-secondary,#6b7280)}.DIJyPq_themeDescription{min-height:36px;color:var(--dsw-alias-label-tertiary,#8b93a1);-webkit-line-clamp:3;-webkit-box-orient:vertical;margin:0;font-size:12px;line-height:18px;display:-webkit-box;overflow:hidden}.DIJyPq_themeCardFooter{justify-content:space-between;align-items:center;gap:8px;margin-top:auto;padding-top:4px;display:flex}.DIJyPq_themeLifecycle{min-width:0;color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:18px;overflow:hidden}.DIJyPq_themeActions{flex-wrap:wrap;justify-content:flex-end;align-items:center;gap:8px;margin-left:auto;display:flex}@container (width<=900px){.DIJyPq_themeGallery{grid-template-columns:repeat(3,minmax(0,1fr))}}@container (width<=680px){.DIJyPq_themeGallery{grid-template-columns:repeat(2,minmax(0,1fr))}}@container (width<=460px){.DIJyPq_themeGallery{grid-template-columns:minmax(0,1fr)}}@container (width<=420px){.DIJyPq_sub{grid-template-columns:minmax(0,1fr) auto;align-items:start;gap:2px 8px;display:grid}.DIJyPq_sub>span:first-child{grid-area:1/1}.DIJyPq_sub>.DIJyPq_grow{display:none}.DIJyPq_submitLink{grid-area:2/1}.DIJyPq_exportLogBtn{flex-shrink:0;grid-area:1/2/span 2}.DIJyPq_themeToolbar{grid-template-columns:minmax(0,1fr)}.DIJyPq_themeCardHead{flex-wrap:wrap}.DIJyPq_themeStatus,.DIJyPq_themeStatusMuted{order:3}}@container (width<=280px){.DIJyPq_themeCardFooter{flex-direction:column;align-items:flex-start}.DIJyPq_themeActions{justify-content:flex-start;width:100%;margin-left:0}}@media (max-width:560px){[role=dialog]:has([data-dsh-market-root])>nav{display:none}[role=dialog]:has([data-dsh-market-root])>div{flex:100%;width:100%;min-width:0}}[role=dialog]:has([data-dsh-market-fullscreen=true]){border-radius:0;width:100vw;max-width:none;height:100vh;max-height:none;position:fixed;top:0;bottom:0;left:0;right:0}@media (prefers-reduced-motion:reduce){.DIJyPq_themeCard,.DIJyPq_themeCover img{transition:none}.DIJyPq_themeCard:hover{transform:none}}.DIJyPq_card{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;align-self:start;gap:12px;padding:12px 14px;display:flex}.DIJyPq_row1{align-items:flex-start;gap:10px;min-width:0;display:flex}.DIJyPq_cardAction{flex-shrink:0;align-items:center;display:inline-flex}.DIJyPq_installBtn.DIJyPq_installBtn{min-width:64px}.DIJyPq_av{color:#fff;object-fit:cover;background:var(--dsw-alias-bg-layer-2,#f3f4f6);border-radius:50%;flex-shrink:0;place-items:center;width:16px;height:16px;font-size:9px;font-weight:700;display:grid}.DIJyPq_nm{text-overflow:ellipsis;white-space:nowrap;font-size:15px;font-weight:600;line-height:22px;overflow:hidden}.DIJyPq_nmLink{color:inherit;text-decoration:none;display:block}.DIJyPq_nmLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.DIJyPq_repoMark{color:var(--dsw-alias-label-secondary,#6b7280);vertical-align:-1px;flex-shrink:0;margin-left:5px;display:inline-block}.DIJyPq_nmLink:hover .DIJyPq_repoMark{color:var(--dsw-alias-brand-primary,#4f6ef7)}.DIJyPq_byline{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.DIJyPq_meta{color:var(--dsw-alias-label-secondary,#9ca3af);margin-top:2px;font-size:11px}.DIJyPq_metaInline{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px}.DIJyPq_owner{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:44px;font-size:11px;overflow:hidden}.DIJyPq_desc{color:var(--dsw-alias-label-tertiary,#8b93a1);margin:0;font-size:12px;line-height:18px}.DIJyPq_descClamp{-webkit-line-clamp:5;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.DIJyPq_descToggle{width:20px;height:16px;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;background:0 0;border:none;justify-content:center;align-items:center;margin-top:2px;padding:0;display:flex}.DIJyPq_descToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.DIJyPq_foot{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.DIJyPq_foot .DIJyPq_metaInline,.DIJyPq_foot .DIJyPq_src{white-space:nowrap}.DIJyPq_grow{flex:1}.DIJyPq_titleRow{align-items:center;gap:10px;display:flex}.DIJyPq_version{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px;line-height:20px}.DIJyPq_repoLink{color:var(--dsw-alias-label-tertiary,#8b93a1);flex-shrink:0;font-size:12px;line-height:20px;text-decoration:none}.DIJyPq_repoLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.DIJyPq_noteRow{flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex}.DIJyPq_noteMine{color:var(--dsw-alias-label-primary,#1f2328)}.DIJyPq_noteToggle{font:inherit;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;white-space:nowrap;background:0 0;border:none;flex-shrink:0;padding:0;font-size:11px;line-height:16px}.DIJyPq_noteToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.DIJyPq_noteAction{color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:4px;align-items:center;padding:0 5px;font-weight:600;text-decoration:none;display:inline-flex}.DIJyPq_noteAction:hover{color:var(--dsw-alias-label-primary,#1f2328);border-color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:none}.DIJyPq_noteEdit{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.DIJyPq_noteInput{flex:1;min-width:160px}.DIJyPq_descTight{min-height:0}.DIJyPq_src{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px;text-decoration:none}.DIJyPq_src:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.DIJyPq_dot{vertical-align:2px;margin-left:5px}.DIJyPq_act{flex-wrap:wrap;align-items:center;gap:6px;margin-top:6px;font-size:11px;display:flex}.DIJyPq_actLive{color:var(--dsw-alias-state-success-primary,#16a34a);align-items:center;gap:4px;font-weight:600;display:inline-flex}.DIJyPq_actWarn{color:var(--dsw-alias-state-warn-primary,#b45309);align-items:center;gap:4px;font-weight:600;display:inline-flex}.DIJyPq_actBroken{color:var(--dsw-alias-state-error-primary,#dc2626);align-items:center;gap:4px;font-weight:600;display:inline-flex}.DIJyPq_actWhy{color:var(--dsw-alias-label-secondary,#6b7280);margin-top:2px}.DIJyPq_loading{color:var(--dsw-alias-label-secondary,#9ca3af);flex-direction:column;align-items:center;gap:12px;padding:48px;font-size:13px;display:flex}.DIJyPq_spin{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;animation:.8s linear infinite DIJyPq_sp;display:inline-flex}.DIJyPq_logoMark{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;display:inline-flex}.DIJyPq_logoPlug{transform-box:fill-box;transform-origin:50%;animation:1.5s cubic-bezier(.4,0,.2,1) infinite DIJyPq_dshmPlug}@keyframes DIJyPq_dshmPlug{0%,12%{transform:rotate(9deg)}45%,62%{transform:translate(-1.28px,1.27px)rotate(0)}95%,to{transform:rotate(9deg)}}@media (prefers-reduced-motion:reduce){.DIJyPq_logoPlug,.DIJyPq_spin{animation:1.5s ease-in-out infinite DIJyPq_dshmPlugFade}}@keyframes DIJyPq_dshmPlugFade{0%,to{opacity:1}50%{opacity:.35}}@keyframes DIJyPq_sp{to{transform:rotate(360deg)}}.DIJyPq_progress{background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:8px;flex-wrap:wrap;align-items:center;gap:9px;margin:0;padding:8px 12px;font-size:12px;display:flex}.DIJyPq_bar{background:var(--dsw-alias-border-l1,#e5e7eb);border-radius:99px;width:100%;height:4px;overflow:hidden}.DIJyPq_barFill{background:var(--dsw-alias-brand-primary,#4f6ef7);border-radius:99px;height:100%;transition:width .6s}.DIJyPq_barWave{width:30%;animation:1.2s ease-in-out infinite DIJyPq_dshmSlide}@keyframes DIJyPq_dshmSlide{0%{margin-left:-30%}to{margin-left:100%}}.DIJyPq_irow .DIJyPq_progress{margin-top:8px}.DIJyPq_progress code{text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.DIJyPq_empty{color:var(--dsw-alias-label-secondary,#9ca3af);text-align:center;padding:32px;font-size:13px}.DIJyPq_err{color:var(--dsw-alias-state-error-primary,#dc2626);white-space:pre-wrap;word-break:break-all;margin:8px 0;font-size:12px}.DIJyPq_cardBlocked{border-color:var(--dsw-alias-state-error-primary,#dc2626)}.DIJyPq_conflictHead{align-items:flex-start;gap:8px;display:flex}.DIJyPq_conflictIcon{color:var(--dsw-alias-state-error-primary,#dc2626);flex-shrink:0;margin-top:1px}.DIJyPq_conflictTitle{color:var(--dsw-alias-state-error-primary,#dc2626);font-size:13px;font-weight:600;line-height:18px}.DIJyPq_conflictBody{margin:0;font-size:12px;line-height:19px}.DIJyPq_roster{background:var(--dsw-alias-border-l2,#e5e7eb);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-direction:column;gap:1px;display:flex;overflow:hidden}.DIJyPq_rosterRow{background:var(--dsw-alias-bg-layer-1,#fff);align-items:center;gap:8px;padding:7px 10px;display:flex}.DIJyPq_rosterMain{flex-direction:column;min-width:0;display:flex}.DIJyPq_rosterName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;font-weight:600;overflow:hidden}.DIJyPq_rosterAuthor{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;overflow:hidden}.DIJyPq_rosterTag{border-radius:4px;flex-shrink:0;margin-left:auto;padding:1px 6px;font-size:10.5px;font-weight:600}.DIJyPq_rosterTagKeep{color:var(--dsw-alias-state-success-primary,#16a34a);background:#16a34a1f}.DIJyPq_rosterTagDrop{color:var(--dsw-alias-state-error-primary,#dc2626);background:#dc26261f}.DIJyPq_rosterRowOut .DIJyPq_rosterName{text-decoration:line-through}.DIJyPq_rosterRowOut{opacity:.62}.DIJyPq_rosterSplit{background:var(--dsw-alias-border-l2,#e5e7eb);height:1px}.DIJyPq_reassure{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:5px;margin:0;font-size:11.5px;line-height:17px;display:flex}.DIJyPq_reassureOk{color:var(--dsw-alias-state-success-primary,#16a34a);flex-shrink:0}.DIJyPq_conflictWhy{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;margin-top:2px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:17px}.DIJyPq_conflictWhyText{margin-top:5px;font-family:-apple-system,BlinkMacSystemFont,PingFang SC,sans-serif}.DIJyPq_choices{flex-direction:column;gap:7px;display:flex}.DIJyPq_choice{text-align:left;font:inherit;cursor:pointer;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:9px;align-items:flex-start;gap:9px;padding:9px 11px;display:flex}.DIJyPq_choice:has(input:disabled){cursor:default;opacity:.6}.DIJyPq_choiceOn{border-color:var(--dsw-alias-brand-primary,#4f6ef7);background:var(--dsw-alias-bg-layer-2,#f5f7ff)}.DIJyPq_choiceRadio{width:13px;height:13px;accent-color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;margin:2px 0 0}.DIJyPq_choiceMain{flex-direction:column;gap:3px;min-width:0;display:flex}.DIJyPq_choiceTitle{font-size:12px;font-weight:600;line-height:17px}.DIJyPq_choiceNote{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px;line-height:16px}.DIJyPq_choiceSafe{color:var(--dsw-alias-state-success-primary,#16a34a)}.DIJyPq_stateTag{white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-height:20px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:5px;flex-shrink:0;align-items:center;gap:5px;padding:1px 7px;font-size:11px;line-height:16px;display:inline-flex}.DIJyPq_stateTag[data-on=true]{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.DIJyPq_stateDot{background:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:999px;flex:none;width:6px;height:6px}.DIJyPq_stateDot[data-on=true]{background:var(--dsw-alias-state-success-primary,#16a34a)}.DIJyPq_metaTag{text-overflow:ellipsis;white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:0;max-width:100%;min-height:20px;color:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:5px;flex-shrink:1;padding:1px 7px;font-size:11px;line-height:18px;display:inline-block;overflow:hidden}.DIJyPq_metaTagOk{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.DIJyPq_nameLink{color:inherit;text-decoration:none}.DIJyPq_irowName{text-overflow:clip;flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex;overflow:visible}.DIJyPq_irowNameText{overflow-wrap:anywhere;white-space:normal;min-width:0}.DIJyPq_irowName>.DIJyPq_owner{flex:none}.DIJyPq_nameLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.DIJyPq_opWrap{flex-shrink:0;display:inline-flex;position:relative}.DIJyPq_opEntry{font:inherit;cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:7px;align-items:center;gap:6px;padding:4px 10px;font-size:12px;display:inline-flex;position:relative}.DIJyPq_opEntryQuiet{color:var(--dsw-alias-label-secondary,#6b7280);background:0 0;border-color:#0000}.DIJyPq_opEntryAlert{border-color:var(--dsw-alias-state-error-primary,#dc2626);color:var(--dsw-alias-state-error-primary,#dc2626)}.DIJyPq_opDot{background:var(--dsw-alias-state-error-primary,#dc2626);border-radius:99px;width:8px;height:8px;position:absolute;top:-3px;right:-3px}.DIJyPq_opPanel{z-index:40;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:12px;width:460px;max-width:86vw;max-height:70vh;position:absolute;top:calc(100% + 6px);right:0;overflow-y:auto;box-shadow:0 20px 52px #00000047}.DIJyPq_opHead{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:center;gap:8px;padding:9px 14px;display:flex}.DIJyPq_opPanelTitle{font-size:12.5px;font-weight:600}.DIJyPq_opCloseBtn.DIJyPq_opCloseBtn{min-width:0;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.DIJyPq_opAggregate{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f7f8fa);padding:9px 14px}.DIJyPq_opAggregateTop{font-variant-numeric:tabular-nums;font-size:12px;font-weight:600}.DIJyPq_opAggregateHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:10.5px}.DIJyPq_opRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-start;gap:9px;padding:9px 14px;display:flex}.DIJyPq_opRow:last-child{border-bottom:none}.DIJyPq_opRowAlert{background:#dc26260f}.DIJyPq_opIcon{flex-shrink:0;place-items:center;width:14px;margin-top:1px;display:grid}.DIJyPq_opQueuedIcon{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px}.DIJyPq_opMain{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.DIJyPq_opTop{align-items:baseline;gap:6px;min-width:0;display:flex}.DIJyPq_opVerb{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:12px}.DIJyPq_opName{text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:600;overflow:hidden}.DIJyPq_opStatus{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;font-size:10.5px;line-height:16px}.DIJyPq_opStatusBad{color:var(--dsw-alias-state-error-primary,#dc2626)}.DIJyPq_opActions{flex-shrink:0;align-items:center;gap:6px;margin-top:1px;display:flex}.DIJyPq_opDecision{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;margin-top:8px;padding-top:8px;display:flex}.DIJyPq_opDecisionFoot{align-items:center;gap:8px;display:flex}.DIJyPq_conflictDetailsToggle{font:inherit;cursor:pointer;color:var(--dsw-alias-label-tertiary,#8b93a1);background:0 0;border:none;align-items:center;gap:4px;padding:2px 0;font-size:11px;display:inline-flex}.DIJyPq_conflictDetailsToggle:hover{color:var(--dsw-alias-label-secondary,#6b7280)}.DIJyPq_opEmpty{text-align:center;color:var(--dsw-alias-label-secondary,#6b7280);padding:30px 14px;font-size:12px}.DIJyPq_opEmptyHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:11px}.DIJyPq_cardBlockedMark{font:inherit;cursor:pointer;color:var(--dsw-alias-state-error-primary,#dc2626);border:1px solid var(--dsw-alias-state-error-primary,#dc2626);background:#dc262614;border-radius:7px;align-items:center;gap:5px;padding:4px 9px;font-size:11px;display:inline-flex}.DIJyPq_dangerBtn.DIJyPq_dangerBtn{color:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626)}.DIJyPq_dangerBtn.DIJyPq_dangerBtn:hover:not(:disabled){background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.DIJyPq_dangerArmed.DIJyPq_dangerArmed{background:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.DIJyPq_retryBtn{margin-top:4px}.DIJyPq_irow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:10px;flex-direction:column;gap:10px;min-width:0;padding:12px 14px;display:flex}.DIJyPq_irowActions{flex-wrap:wrap;justify-content:flex-start;align-items:center;gap:8px;min-width:0;display:flex}.DIJyPq_irowTrailing{flex-wrap:nowrap;align-items:center;gap:8px;min-width:0;display:inline-flex}.DIJyPq_irowMissing{filter:grayscale();opacity:.5}.DIJyPq_irow>.DIJyPq_src,.DIJyPq_irow>.DIJyPq_owner,.DIJyPq_irow button{white-space:nowrap;flex-shrink:0}.DIJyPq_tabSearchRow{padding:0 4px 6px;display:flex}.DIJyPq_tabSearch{width:100%}.DIJyPq_spec{color:var(--dsw-alias-label-secondary,#9ca3af);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:11px}.DIJyPq_specTag{white-space:nowrap;border-radius:4px;flex-shrink:0;align-items:center;height:16px;padding:0 5px;font-size:10px;font-weight:600;display:inline-flex}.DIJyPq_specTagGit{color:#0b7285;background:#12a3c41f}.DIJyPq_specTagFile{color:#b07d1b;background:#f0b42924}.DIJyPq_backupCheckList .DIJyPq_grow{white-space:nowrap;text-overflow:ellipsis;flex:70%;min-width:0;overflow:hidden}.DIJyPq_backupCheckList .DIJyPq_spec{text-align:right;white-space:nowrap;text-overflow:ellipsis;flex:0 30%;max-width:30%;overflow:hidden}.DIJyPq_staleAction{margin-top:8px}.DIJyPq_pct{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:11px;font-weight:600}.DIJyPq_pager{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;margin:16px 0 4px;display:flex}.DIJyPq_pagerPages{flex-wrap:wrap;flex:1;justify-content:center;align-items:center;gap:6px;min-width:0;display:flex}.DIJyPq_pageEllipsis{color:var(--dsw-alias-label-secondary,#9ca3af);padding:0 2px;font-size:12px}.DIJyPq_pageInfo{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;font-size:12px}.DIJyPq_depBadge{border:1px solid var(--dsw-alias-state-warn-primary,#b45309);color:var(--dsw-alias-state-warn-primary,#b45309);white-space:nowrap;border-radius:4px;flex-shrink:0;margin-left:6px;padding:1px 6px;font-size:11px;font-weight:600;line-height:16px}.DIJyPq_deprecate{color:var(--dsw-alias-state-warn-primary,#b45309);background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;margin:0;padding:8px 10px;font-size:12px;line-height:18px}.DIJyPq_deprecate a{color:var(--dsw-alias-state-warn-primary,#b45309);text-decoration:underline}.DIJyPq_deprecate .DIJyPq_src{margin-left:8px}.DIJyPq_depLine{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.DIJyPq_switch{border:1px solid var(--dsw-alias-border-l2,#d9dde3);background:var(--dsw-alias-bg-layer-2,#e5e7eb);cursor:pointer;border-radius:99px;flex-shrink:0;width:38px;height:22px;padding:0;transition:background .15s,border-color .15s;position:relative}.DIJyPq_switchOn{background:var(--dsw-alias-state-success-primary,#16a34a);border-color:var(--dsw-alias-state-success-primary,#16a34a)}.DIJyPq_switchMixed{background:var(--dsw-alias-state-warn-primary,#b45309);border-color:var(--dsw-alias-state-warn-primary,#b45309)}.DIJyPq_switchKnob{background:#fff;border-radius:99px;width:16px;height:16px;transition:left .15s;position:absolute;top:2px;left:2px;box-shadow:0 1px 2px #00000040}.DIJyPq_switchOn .DIJyPq_switchKnob,.DIJyPq_switchMixed .DIJyPq_switchKnob{left:18px}.DIJyPq_switch:disabled{opacity:.5;cursor:default}.DIJyPq_viewBar{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;align-items:center;gap:2px;width:fit-content;margin-bottom:12px;padding:2px;display:flex}.DIJyPq_viewBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-radius:6px;padding:4px 10px;font-size:12px;line-height:18px}.DIJyPq_viewBtn:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.DIJyPq_viewOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.DIJyPq_groupRow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;margin-bottom:10px;padding:12px 14px}.DIJyPq_groupHead{align-items:center;gap:10px;min-width:0;display:flex}.DIJyPq_groupName{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.DIJyPq_groupActions{flex-shrink:0;align-items:center;gap:6px;display:flex}.DIJyPq_groupMembers{flex-direction:column;gap:6px;margin-top:10px;display:flex}.DIJyPq_groupMember{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:12px;line-height:18px;display:flex}.DIJyPq_groupMember .DIJyPq_nm{flex:1;min-width:0;font-size:12px}.DIJyPq_groupAddPanel{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:6px;margin-top:10px;padding-top:10px;display:flex}.DIJyPq_groupCreate{align-items:center;gap:8px;margin-bottom:10px;display:flex}.DIJyPq_inlineInput{flex:1;min-width:120px}.DIJyPq_assignRow{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.DIJyPq_assignSelect{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#1f2328);font:inherit;border-radius:6px;padding:3px 6px;font-size:12px;line-height:18px}.DIJyPq_groupHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px}.DIJyPq_sectAction{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:8px;margin:14px 2px 8px;font-size:12px;font-weight:600;display:flex}.DIJyPq_backupGrid{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:12px;display:grid}.DIJyPq_backupCard{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:10px;padding:16px;display:flex}.DIJyPq_backupCard h3{margin:0;font-size:14px}.DIJyPq_backupCard p{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.DIJyPq_backupActions{flex-wrap:wrap;gap:8px;display:flex;position:relative}.DIJyPq_hiddenFile{opacity:0;pointer-events:none;width:1px;height:1px;position:absolute}.DIJyPq_backupInput{box-sizing:border-box;width:100%}.DIJyPq_backupCheck{cursor:pointer;align-items:center;gap:6px;font-size:12px;display:flex}.DIJyPq_backupWarn{margin:0;font-size:12px;line-height:18px;color:var(--dsw-alias-state-warn-primary,#b45309)!important}.DIJyPq_backupMessage{color:var(--dsw-alias-label-secondary,#6b7280);grid-column:1/-1;font-size:12px}.DIJyPq_backupCheckList{flex-direction:column;gap:6px;max-height:260px;margin:10px 0 4px;padding-right:4px;display:flex;overflow-y:auto}.DIJyPq_backupCheckList .DIJyPq_backupCheck{justify-content:space-between;gap:8px}.DIJyPq_diagPage{flex-direction:column;gap:12px;height:100%;min-height:0;display:flex;overflow-y:auto}.DIJyPq_diagSummary{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-wrap:wrap;align-items:center;gap:12px;padding:10px 14px;font-size:12px;display:flex}.DIJyPq_diagSummaryItem{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;align-items:center;gap:6px;display:inline-flex}.DIJyPq_diagSummaryMeta{color:var(--dsw-alias-label-tertiary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;max-width:320px;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.DIJyPq_diagSection{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:8px;padding:12px 14px;display:flex}.DIJyPq_diagSection h3{color:var(--dsw-alias-label-primary,#1f2328);margin:0;font-size:13px;font-weight:600}.DIJyPq_diagCount{color:var(--dsw-alias-label-tertiary,#9ca3af);font-size:11px;font-weight:400}.DIJyPq_diagEmpty{color:var(--dsw-alias-label-secondary,#9ca3af);padding:8px 0;font-size:12px}.DIJyPq_diagBundle{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);flex-direction:column;gap:6px;padding-top:8px;display:flex}.DIJyPq_diagBundle:first-of-type{border-top:none;padding-top:0}.DIJyPq_diagRow{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;font-size:12px;line-height:18px;display:flex}.DIJyPq_diagMeta{align-items:baseline;gap:8px;min-width:0;font-size:12px;display:flex}.DIJyPq_diagKey{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;min-width:64px;font-size:11px}.DIJyPq_diagVal{color:var(--dsw-alias-label-primary,#1f2328);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:12px;font-weight:500}.DIJyPq_diagIndex{background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:18px;height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;justify-content:center;align-items:center;font-size:11px;font-weight:600;display:inline-flex}.DIJyPq_diagArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.DIJyPq_diagBadgeOfficial{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.DIJyPq_diagBadgeCommunity{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.DIJyPq_diagBadgeShadow{background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.DIJyPq_diagBadgeWarn{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.DIJyPq_diagBadgeInfo{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.DIJyPq_diagList{flex-direction:column;gap:6px;display:flex}.DIJyPq_sectionOverview{color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;max-width:100%;padding:2px 0 6px;font-size:12px;line-height:18px;overflow:hidden}.DIJyPq_diagAlert{color:var(--dsw-alias-state-warn-primary,#b45309)}.DIJyPq_ovRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.DIJyPq_ovArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.DIJyPq_ovByTag{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;text-overflow:ellipsis;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;max-width:260px;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex;overflow:hidden}.DIJyPq_ovFrom{color:var(--dsw-alias-label-secondary,#6b7280);text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;overflow:hidden}.DIJyPq_orphRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.DIJyPq_orphBadge{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.DIJyPq_dragHandle{width:20px;height:20px;color:var(--dsw-alias-label-tertiary,#9ca3af);cursor:grab;-webkit-user-select:none;user-select:none;flex-shrink:0;justify-content:center;align-items:center;font-size:12px;line-height:20px;display:inline-flex}.DIJyPq_dragOver{outline:2px dashed var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:2px;background:var(--dsw-alias-bg-layer-2,#f0f2f8);border-radius:8px}.DIJyPq_dragging{opacity:.45;background:var(--dsw-alias-bg-layer-2,#f3f4f6)}.DIJyPq_collapseHead{font:inherit;color:var(--dsw-alias-label-primary,#1f2328);cursor:pointer;text-align:left;background:0 0;border:none;align-items:center;gap:8px;width:100%;padding:0;font-size:13px;font-weight:600;display:flex}.DIJyPq_collapseIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;display:inline-flex}.DIJyPq_collapseTitle{flex:1;min-width:0}.DIJyPq_collapseBody{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);overflow-wrap:anywhere;flex-direction:column;gap:10px;min-width:0;margin-top:8px;padding-top:10px;display:flex}.DIJyPq_orderPanel{flex-direction:column;gap:10px;min-width:0;display:flex}.DIJyPq_panelNote{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.DIJyPq_panelActions{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.DIJyPq_presetList{flex-direction:column;gap:6px;min-width:0;display:flex}.DIJyPq_presetRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:6px;min-width:0;max-width:100%;padding:8px 10px;font-size:12px;line-height:18px;display:flex}.DIJyPq_presetName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:13px;font-weight:600;overflow:hidden}.DIJyPq_snapList{flex-direction:column;gap:6px;min-width:0;display:flex}.DIJyPq_snapRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:8px;padding:10px 12px;font-size:12px;line-height:18px;display:flex}.DIJyPq_snapMeta{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;display:flex}.DIJyPq_snapConfirmText{color:var(--dsw-alias-state-warn-primary,#b45309);margin:0;font-size:12px;line-height:18px}.DIJyPq_confirmRow{flex-wrap:wrap;align-items:center;gap:6px;display:inline-flex}.DIJyPq_fixFallback{flex-direction:column;gap:6px;margin:8px 0;display:flex}.DIJyPq_fixFallbackText{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);resize:vertical;white-space:pre-wrap;word-break:break-all;border-radius:6px;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:16px}.DIJyPq_setCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-3,#fff);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.DIJyPq_setCard:hover{border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.DIJyPq_setCardOpen{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.DIJyPq_setHeader{-webkit-appearance:none;appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.DIJyPq_setHeader:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:-2px}.DIJyPq_setHeadText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.DIJyPq_setName{color:var(--dsw-alias-label-primary,#1f2328);font-size:15px;font-weight:600;line-height:1.4}.DIJyPq_setDesc{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:13px;line-height:1.5}.DIJyPq_setChevron{color:var(--dsw-alias-label-tertiary,#8b93a1);flex:none;transition:transform .16s;display:inline-flex}.DIJyPq_setChevronOpen{transform:rotate(180deg)}.DIJyPq_setBody{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);margin:0 16px;padding-bottom:8px}.DIJyPq_setRow{align-items:center;gap:12px;padding:12px 0;display:flex}.DIJyPq_setRow+.DIJyPq_setRow{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb)}.DIJyPq_setLabelBox{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.DIJyPq_setLabel{font-size:13px;line-height:20px}.DIJyPq_setHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px;line-height:18px}.DIJyPq_setConfirm{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;padding:12px 0 4px;display:flex}.DIJyPq_setCheck{cursor:pointer;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.DIJyPq_setActions{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.DIJyPq_setDanger{color:var(--dsw-alias-state-error-primary,#dc2626)}.DIJyPq_setSeg{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-shrink:0;gap:2px;padding:2px;display:inline-flex}.DIJyPq_setSegBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;background:0 0;border:none;border-radius:6px;padding:3px 10px;font-size:12px;line-height:18px}.DIJyPq_setSegBtn:disabled{cursor:default;opacity:.5}.DIJyPq_setSegOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.DIJyPq_setBetaTag{background:var(--dsw-alias-bg-module-platform,#eef0f4);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;margin-left:6px;padding:0 6px;font-size:11px;font-weight:600;line-height:17px}.DIJyPq_commentsLink{cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-secondary,#9ca3af);background:0 0;border:0;padding:0;font-size:11px;line-height:16px}.DIJyPq_commentsLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.DIJyPq_commentsNote{color:var(--dsw-alias-label-secondary,#9ca3af);margin:0 0 8px;font-size:11px;line-height:16px}.DIJyPq_commentsStatus{color:var(--dsw-alias-label-secondary,#9ca3af);margin:0;font-size:12px}.DIJyPq_commentsStatus:empty{display:none}.DIJyPq_commentsError{color:var(--dsw-alias-label-primary,#1f2328);margin:0 0 8px;font-size:12px}.DIJyPq_commentsFail{flex-direction:column;align-items:flex-start;gap:8px;padding:12px 0;display:flex}.DIJyPq_commentsMount{width:100%;min-height:240px;max-height:56vh;overflow:auto}.DIJyPq_commentsMount iframe{width:100%}.DIJyPq_notesLink{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;text-align:left;background:0 0;border:none;margin:2px 0 0;padding:0;font-size:12px;line-height:18px;display:block}.DIJyPq_notesLink:hover{color:var(--dsw-alias-label-primary,#1f2328)}.DIJyPq_notesBody{flex-direction:column;gap:8px;min-width:0;display:flex}.DIJyPq_notesRange{align-items:center;gap:8px;margin-bottom:4px;font-size:12px;line-height:18px;display:flex}.DIJyPq_notesArrow{color:var(--dsw-alias-label-tertiary,#8b93a1)}.DIJyPq_notesMeta{letter-spacing:.02em;text-transform:uppercase;color:var(--dsw-alias-label-secondary,#6b7280);flex-wrap:wrap;align-items:baseline;gap:6px;margin-top:12px;font-size:12px;line-height:18px;display:flex}.DIJyPq_notesPre{white-space:pre-wrap;word-break:break-word;background:var(--dsw-alias-bg-layer-2,#eef0f4);border-radius:8px;max-height:40vh;margin:0;padding:10px 12px;font-size:13px;line-height:20px;overflow:auto}.DIJyPq_notesList{flex-direction:column;gap:6px;margin:0;padding-left:18px;font-size:13px;line-height:20px;display:flex}.DIJyPq_notesRendered{flex-direction:column;gap:6px;min-width:0;display:flex}.DIJyPq_notesH{margin-top:6px;font-size:13px;font-weight:650;line-height:20px}.DIJyPq_notesP{font-size:13px;line-height:20px}.DIJyPq_notesCode{font-family:var(--dsw-alias-font-mono,ui-monospace,monospace);background:var(--dsw-alias-bg-layer-2,#eef0f4);border-radius:5px;padding:1px 5px;font-size:12px}.DIJyPq_notesList{flex-direction:column;margin:0;padding:0;list-style:none;display:flex}.DIJyPq_notesRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:baseline;gap:12px;padding:6px 0;display:flex}.DIJyPq_notesRow:last-child{border-bottom:none}.DIJyPq_notesDate{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px}.DIJyPq_notesMsg{word-break:break-word;word-break:break-word;-webkit-line-clamp:3;-webkit-box-orient:vertical;min-width:0;font-size:13px;line-height:20px;display:-webkit-box;overflow:hidden}.DIJyPq_notesSha{color:var(--dsw-alias-label-secondary,#6b7280);font-variant-numeric:tabular-nums;flex-shrink:0;margin-left:auto;font-size:12px;text-decoration:none}.DIJyPq_notesSha:hover{color:var(--dsw-alias-label-primary,#1f2328);text-decoration:underline}.DIJyPq_notesVer{color:inherit;font-weight:600;text-decoration:none}.DIJyPq_notesVer:hover{text-decoration:underline}";
		...
		var Market_module_css_default = {
			"act": "DIJyPq_act",
			"actBroken": "DIJyPq_actBroken",
			"actLive": "DIJyPq_actLive",
			"actWarn": "DIJyPq_actWarn",
			"actWhy": "DIJyPq_actWhy",
			"assignRow": "DIJyPq_assignRow",
			"assignSelect": "DIJyPq_assignSelect",
			"av": "DIJyPq_av",
			"backupActions": "DIJyPq_backupActions",
			"backupCard": "DIJyPq_backupCard",
			"backupCheck": "DIJyPq_backupCheck",
			"backupCheckList": "DIJyPq_backupCheckList",
			"backupGrid": "DIJyPq_backupGrid",
			"backupInput": "DIJyPq_backupInput",
			"backupMessage": "DIJyPq_backupMessage",
			"backupWarn": "DIJyPq_backupWarn",
			"banner": "DIJyPq_banner",
			"bannerHint": "DIJyPq_bannerHint",
			"bannerIcon": "DIJyPq_bannerIcon",
			"bar": "DIJyPq_bar",
			"barFill": "DIJyPq_barFill",
			"barWave": "DIJyPq_barWave",
			"body": "DIJyPq_body",
			"byline": "DIJyPq_byline",
			"card": "DIJyPq_card",
			"cardAction": "DIJyPq_cardAction",
			"cardBlocked": "DIJyPq_cardBlocked",
			"cardBlockedMark": "DIJyPq_cardBlockedMark",
			"cardShot": "DIJyPq_cardShot",
			"cardShots": "DIJyPq_cardShots",
			"cats": "DIJyPq_cats",
			"catsCollapsed": "DIJyPq_catsCollapsed",
			"catsRow": "DIJyPq_catsRow",
			"catsToggle": "DIJyPq_catsToggle",
			"catsWrap": "DIJyPq_catsWrap",
			"choice": "DIJyPq_choice",
			"choiceMain": "DIJyPq_choiceMain",
			"choiceNote": "DIJyPq_choiceNote",
			"choiceOn": "DIJyPq_choiceOn",
			"choiceRadio": "DIJyPq_choiceRadio",
			"choices": "DIJyPq_choices",
			"choiceSafe": "DIJyPq_choiceSafe",
			"choiceTitle": "DIJyPq_choiceTitle",
			"cmd": "DIJyPq_cmd",
			"collapseBody": "DIJyPq_collapseBody",
			"collapseHead": "DIJyPq_collapseHead",
			"collapseIcon": "DIJyPq_collapseIcon",
			"collapseTitle": "DIJyPq_collapseTitle",
			"commentsError": "DIJyPq_commentsError",
			"commentsFail": "DIJyPq_commentsFail",
			"commentsLink": "DIJyPq_commentsLink",
			"commentsMount": "DIJyPq_commentsMount",
			"commentsNote": "DIJyPq_commentsNote",
			"commentsStatus": "DIJyPq_commentsStatus",
			"confirmRow": "DIJyPq_confirmRow",
			"conflictBody": "DIJyPq_conflictBody",
			"conflictDetailsToggle": "DIJyPq_conflictDetailsToggle",
			"conflictHead": "DIJyPq_conflictHead",
			"conflictIcon": "DIJyPq_conflictIcon",
			"conflictTitle": "DIJyPq_conflictTitle",
			"conflictWhy": "DIJyPq_conflictWhy",
			"conflictWhyText": "DIJyPq_conflictWhyText",
			"dangerArmed": "DIJyPq_dangerArmed",
			"dangerBtn": "DIJyPq_dangerBtn",
			"depBadge": "DIJyPq_depBadge",
			"depLine": "DIJyPq_depLine",
			"deprecate": "DIJyPq_deprecate",
			"desc": "DIJyPq_desc",
			"descClamp": "DIJyPq_descClamp",
			"descTight": "DIJyPq_descTight",
			"descToggle": "DIJyPq_descToggle",
			"diagAlert": "DIJyPq_diagAlert",
			"diagArrow": "DIJyPq_diagArrow",
			"diagBadgeCommunity": "DIJyPq_diagBadgeCommunity",
			"diagBadgeInfo": "DIJyPq_diagBadgeInfo",
			"diagBadgeOfficial": "DIJyPq_diagBadgeOfficial",
			"diagBadgeShadow": "DIJyPq_diagBadgeShadow",
			"diagBadgeWarn": "DIJyPq_diagBadgeWarn",
			"diagBundle": "DIJyPq_diagBundle",
			"diagCount": "DIJyPq_diagCount",
			"diagEmpty": "DIJyPq_diagEmpty",
			"diagIndex": "DIJyPq_diagIndex",
			"diagKey": "DIJyPq_diagKey",
			"diagList": "DIJyPq_diagList",
			"diagMeta": "DIJyPq_diagMeta",
			"diagPage": "DIJyPq_diagPage",
			"diagRow": "DIJyPq_diagRow",
			"diagSection": "DIJyPq_diagSection",
			"diagSummary": "DIJyPq_diagSummary",
			"diagSummaryItem": "DIJyPq_diagSummaryItem",
			"diagSummaryMeta": "DIJyPq_diagSummaryMeta",
			"diagVal": "DIJyPq_diagVal",
			"dot": "DIJyPq_dot",
			"dragging": "DIJyPq_dragging",
			"dragHandle": "DIJyPq_dragHandle",
			"dragOver": "DIJyPq_dragOver",
			"dshmPlug": "DIJyPq_dshmPlug",
			"dshmPlugFade": "DIJyPq_dshmPlugFade",
			"dshmSlide": "DIJyPq_dshmSlide",
			"empty": "DIJyPq_empty",
			"err": "DIJyPq_err",
			"exportLogBtn": "DIJyPq_exportLogBtn",
			"fixFallback": "DIJyPq_fixFallback",
			"fixFallbackText": "DIJyPq_fixFallbackText",
			"foot": "DIJyPq_foot",
			"grid": "DIJyPq_grid",
			"groupActions": "DIJyPq_groupActions",
			"groupAddPanel": "DIJyPq_groupAddPanel",
			"groupCreate": "DIJyPq_groupCreate",
			"groupHead": "DIJyPq_groupHead",
			"groupHint": "DIJyPq_groupHint",
			"groupMember": "DIJyPq_groupMember",
			"groupMembers": "DIJyPq_groupMembers",
			"groupName": "DIJyPq_groupName",
			"groupRow": "DIJyPq_groupRow",
			"grow": "DIJyPq_grow",
			"head": "DIJyPq_head",
			"hiddenFile": "DIJyPq_hiddenFile",
			"inlineInput": "DIJyPq_inlineInput",
			"installBtn": "DIJyPq_installBtn",
			"irow": "DIJyPq_irow",
			"irowActions": "DIJyPq_irowActions",
			"irowMissing": "DIJyPq_irowMissing",
			"irowName": "DIJyPq_irowName",
			"irowNameText": "DIJyPq_irowNameText",
			"irowTrailing": "DIJyPq_irowTrailing",
			"lightbox": "DIJyPq_lightbox",
			"lightboxClose": "DIJyPq_lightboxClose",
			"lightboxDot": "DIJyPq_lightboxDot",
			"lightboxDotOn": "DIJyPq_lightboxDotOn",
			"lightboxDots": "DIJyPq_lightboxDots",
			"lightboxImg": "DIJyPq_lightboxImg",
			"lightboxNav": "DIJyPq_lightboxNav",
			"lightboxNext": "DIJyPq_lightboxNext",
			"lightboxPrev": "DIJyPq_lightboxPrev",
			"loading": "DIJyPq_loading",
			"logoMark": "DIJyPq_logoMark",
			"logoPlug": "DIJyPq_logoPlug",
			"masonry": "DIJyPq_masonry",
			"masonryCol": "DIJyPq_masonryCol",
			"meta": "DIJyPq_meta",
			"metaInline": "DIJyPq_metaInline",
			"metaTag": "DIJyPq_metaTag",
			"metaTagOk": "DIJyPq_metaTagOk",
			"modalNote": "DIJyPq_modalNote",
			"nameLink": "DIJyPq_nameLink",
			"nm": "DIJyPq_nm",
			"nmLink": "DIJyPq_nmLink",
			"noteAction": "DIJyPq_noteAction",
			"noteEdit": "DIJyPq_noteEdit",
			"noteInput": "DIJyPq_noteInput",
			"noteMine": "DIJyPq_noteMine",
			"noteRow": "DIJyPq_noteRow",
			"notesArrow": "DIJyPq_notesArrow",
			"notesBody": "DIJyPq_notesBody",
			"notesCode": "DIJyPq_notesCode",
			"notesDate": "DIJyPq_notesDate",
			"notesH": "DIJyPq_notesH",
			"notesLink": "DIJyPq_notesLink",
			"notesList": "DIJyPq_notesList",
			"notesMeta": "DIJyPq_notesMeta",
			"notesMsg": "DIJyPq_notesMsg",
			"notesP": "DIJyPq_notesP",
			"notesPre": "DIJyPq_notesPre",
			"notesRange": "DIJyPq_notesRange",
			"notesRendered": "DIJyPq_notesRendered",
			"notesRow": "DIJyPq_notesRow",
			"notesSha": "DIJyPq_notesSha",
			"notesVer": "DIJyPq_notesVer",
			"noteToggle": "DIJyPq_noteToggle",
			"okState": "DIJyPq_okState",
			"on": "DIJyPq_on",
			"opActions": "DIJyPq_opActions",
			"opAggregate": "DIJyPq_opAggregate",
			"opAggregateHint": "DIJyPq_opAggregateHint",
			"opAggregateTop": "DIJyPq_opAggregateTop",
			"opCloseBtn": "DIJyPq_opCloseBtn",
			"opDecision": "DIJyPq_opDecision",
			"opDecisionFoot": "DIJyPq_opDecisionFoot",
			"opDot": "DIJyPq_opDot",
			"opEmpty": "DIJyPq_opEmpty",
			"opEmptyHint": "DIJyPq_opEmptyHint",
			"opEntry": "DIJyPq_opEntry",
			"opEntryAlert": "DIJyPq_opEntryAlert",
			"opEntryQuiet": "DIJyPq_opEntryQuiet",
			"opHead": "DIJyPq_opHead",
			"opIcon": "DIJyPq_opIcon",
			"opMain": "DIJyPq_opMain",
			"opName": "DIJyPq_opName",
			"opPanel": "DIJyPq_opPanel",
			"opPanelTitle": "DIJyPq_opPanelTitle",
			"opQueuedIcon": "DIJyPq_opQueuedIcon",
			"opRow": "DIJyPq_opRow",
			"opRowAlert": "DIJyPq_opRowAlert",
			"opStatus": "DIJyPq_opStatus",
			"opStatusBad": "DIJyPq_opStatusBad",
			"opTop": "DIJyPq_opTop",
			"opVerb": "DIJyPq_opVerb",
			"opWrap": "DIJyPq_opWrap",
			"orderPanel": "DIJyPq_orderPanel",
			"orphBadge": "DIJyPq_orphBadge",
			"orphRow": "DIJyPq_orphRow",
			"ovArrow": "DIJyPq_ovArrow",
			"ovByTag": "DIJyPq_ovByTag",
			"ovFrom": "DIJyPq_ovFrom",
			"ovRow": "DIJyPq_ovRow",
			"owner": "DIJyPq_owner",
			"pageEllipsis": "DIJyPq_pageEllipsis",
			"pageInfo": "DIJyPq_pageInfo",
			"pager": "DIJyPq_pager",
			"pagerPages": "DIJyPq_pagerPages",
			"panelActions": "DIJyPq_panelActions",
			"panelNote": "DIJyPq_panelNote",
			"pct": "DIJyPq_pct",
			"presetList": "DIJyPq_presetList",
			"presetName": "DIJyPq_presetName",
			"presetRow": "DIJyPq_presetRow",
			"progress": "DIJyPq_progress",
			"reassure": "DIJyPq_reassure",
			"reassureOk": "DIJyPq_reassureOk",
			"repoLink": "DIJyPq_repoLink",
			"repoMark": "DIJyPq_repoMark",
			"retryBtn": "DIJyPq_retryBtn",
			"root": "DIJyPq_root",
			"roster": "DIJyPq_roster",
			"rosterAuthor": "DIJyPq_rosterAuthor",
			"rosterMain": "DIJyPq_rosterMain",
			"rosterName": "DIJyPq_rosterName",
			"rosterRow": "DIJyPq_rosterRow",
			"rosterRowOut": "DIJyPq_rosterRowOut",
			"rosterSplit": "DIJyPq_rosterSplit",
			"rosterTag": "DIJyPq_rosterTag",
			"rosterTagDrop": "DIJyPq_rosterTagDrop",
			"rosterTagKeep": "DIJyPq_rosterTagKeep",
			"row1": "DIJyPq_row1",
			"sectAction": "DIJyPq_sectAction",
			"sectionOverview": "DIJyPq_sectionOverview",
			"setActions": "DIJyPq_setActions",
			"setBetaTag": "DIJyPq_setBetaTag",
			"setBody": "DIJyPq_setBody",
			"setCard": "DIJyPq_setCard",
			"setCardOpen": "DIJyPq_setCardOpen",
			"setCheck": "DIJyPq_setCheck",
			"setChevron": "DIJyPq_setChevron",
			"setChevronOpen": "DIJyPq_setChevronOpen",
			"setConfirm": "DIJyPq_setConfirm",
			"setDanger": "DIJyPq_setDanger",
			"setDesc": "DIJyPq_setDesc",
			"setHeader": "DIJyPq_setHeader",
			"setHeadText": "DIJyPq_setHeadText",
			"setHint": "DIJyPq_setHint",
			"setLabel": "DIJyPq_setLabel",
			"setLabelBox": "DIJyPq_setLabelBox",
			"setName": "DIJyPq_setName",
			"setRow": "DIJyPq_setRow",
			"setSeg": "DIJyPq_setSeg",
			"setSegBtn": "DIJyPq_setSegBtn",
			"setSegOn": "DIJyPq_setSegOn",
			"shot": "DIJyPq_shot",
			"shots": "DIJyPq_shots",
			"snapConfirmText": "DIJyPq_snapConfirmText",
			"snapList": "DIJyPq_snapList",
			"snapMeta": "DIJyPq_snapMeta",
			"snapRow": "DIJyPq_snapRow",
			"sp": "DIJyPq_sp",
			"spec": "DIJyPq_spec",
			"specTag": "DIJyPq_specTag",
			"specTagFile": "DIJyPq_specTagFile",
			"specTagGit": "DIJyPq_specTagGit",
			"spin": "DIJyPq_spin",
			"src": "DIJyPq_src",
			"staleAction": "DIJyPq_staleAction",
			"star": "DIJyPq_star",
			"stateDot": "DIJyPq_stateDot",
			"stateTag": "DIJyPq_stateTag",
			"stickyHead": "DIJyPq_stickyHead",
			"sub": "DIJyPq_sub",
			"submitLink": "DIJyPq_submitLink",
			"subTabs": "DIJyPq_subTabs",
			"swatches": "DIJyPq_swatches",
			"switch": "DIJyPq_switch",
			"switchKnob": "DIJyPq_switchKnob",
			"switchMixed": "DIJyPq_switchMixed",
			"switchOn": "DIJyPq_switchOn",
			"tab": "DIJyPq_tab",
			"tabs": "DIJyPq_tabs",
			"tabSearch": "DIJyPq_tabSearch",
			"tabSearchRow": "DIJyPq_tabSearchRow",
			"tag": "DIJyPq_tag",
			"themeActions": "DIJyPq_themeActions",
			"themeCard": "DIJyPq_themeCard",
			"themeCardBody": "DIJyPq_themeCardBody",
			"themeCardFooter": "DIJyPq_themeCardFooter",
			"themeCardHead": "DIJyPq_themeCardHead",
			"themeCover": "DIJyPq_themeCover",
			"themeCoverEmpty": "DIJyPq_themeCoverEmpty",
			"themeDescription": "DIJyPq_themeDescription",
			"themeFullscreenBtn": "DIJyPq_themeFullscreenBtn",
			"themeGallery": "DIJyPq_themeGallery",
			"themeIdentity": "DIJyPq_themeIdentity",
			"themeLifecycle": "DIJyPq_themeLifecycle",
			"themePreviewAction": "DIJyPq_themePreviewAction",
			"themePreviewCount": "DIJyPq_themePreviewCount",
			"themeResultBar": "DIJyPq_themeResultBar",
			"themeSearch": "DIJyPq_themeSearch",
			"themesGrid": "DIJyPq_themesGrid",
			"themeStatus": "DIJyPq_themeStatus",
			"themeStatusMuted": "DIJyPq_themeStatusMuted",
			"themeToolbar": "DIJyPq_themeToolbar",
			"themeToolbarActions": "DIJyPq_themeToolbarActions",
			"title": "DIJyPq_title",
			"titleRow": "DIJyPq_titleRow",
			"top": "DIJyPq_top",
			"topBtn": "DIJyPq_topBtn",
			"version": "DIJyPq_version",
			"viewBar": "DIJyPq_viewBar",
			"viewBtn": "DIJyPq_viewBtn",
			"viewOn": "DIJyPq_viewOn",
			"warnLine": "DIJyPq_warnLine"
		};
		//#endregion
