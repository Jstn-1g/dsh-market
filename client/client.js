window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		*/
		...
		const css = ".VisrYW_root{min-width:0;height:100%;color:var(--dsw-alias-label-primary,#1f2328);flex-direction:column;display:flex;position:relative;container-type:inline-size}.VisrYW_head{flex-direction:column;gap:12px;padding:4px 4px 6px;display:flex}.VisrYW_title{margin:0;font-size:16px;font-weight:500;line-height:24px}.VisrYW_sub{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:8px;margin:0;font-size:12px;line-height:18px;display:flex}.VisrYW_submitLink{color:var(--dsw-alias-label-tertiary,#8b93a1);white-space:nowrap;font-size:11px;line-height:18px;text-decoration:none}.VisrYW_submitLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.VisrYW_tabs{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-end;gap:2px;display:flex}.VisrYW_tab{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-bottom:2px solid #0000;padding:7px 12px;font-size:13px}.VisrYW_tab.VisrYW_on{color:var(--dsw-alias-brand-primary,#4f6ef7);border-bottom-color:var(--dsw-alias-brand-primary,#4f6ef7);font-weight:600}.VisrYW_subTabs{align-items:flex-end;gap:2px;margin:-4px 0 4px;display:flex}.VisrYW_banner{background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;align-items:center;gap:8px;margin:0;padding:8px 12px;font-size:12px;display:flex}.VisrYW_bannerIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0}.VisrYW_bannerHint{color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:help;display:inline-flex}.VisrYW_body{overflow-anchor:none;flex:1;padding:12px 4px 24px;overflow-x:hidden;overflow-y:auto}.VisrYW_stickyHead{z-index:5;background:var(--dsw-alias-bg-layer-2,#f7f8fa);position:sticky;top:-1px}.VisrYW_stickyHead:before{content:\"\";background:inherit;pointer-events:none;height:14px;position:absolute;bottom:100%;left:0;right:0}.VisrYW_cats{margin:0 -4px 2px;padding:12px 4px 4px}.VisrYW_catsRow{align-items:flex-start;gap:8px;display:flex;position:relative}.VisrYW_star{color:var(--dsw-alias-label-secondary,#9ca3af);white-space:nowrap;flex:none;font-size:11px}.VisrYW_top{z-index:20;display:inline-flex;position:absolute;bottom:18px;right:18px}.VisrYW_topBtn{border-radius:99px;width:38px;height:38px;padding:0}.VisrYW_tag{border:1px solid var(--dsw-alias-border-l3,#d9dde3);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:4px;flex-shrink:0;padding:1px 6px;font-size:11px;line-height:16px}.VisrYW_okState{color:var(--dsw-alias-state-success-primary,#16a34a);white-space:nowrap;font-size:12px;font-weight:600}.VisrYW_catsWrap{flex-wrap:wrap;flex:1;align-items:center;gap:6px;min-width:0;display:flex}.VisrYW_catsCollapsed{max-height:62px;overflow:hidden}.VisrYW_catsToggle.VisrYW_catsToggle{height:26px;min-height:26px;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.VisrYW_shots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:8px;margin:6px 0 8px;padding:2px 0 6px;display:flex;overflow-x:auto}.VisrYW_shot{object-fit:cover;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:220px;height:150px}.VisrYW_cardShots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:6px;margin:0 0 6px;padding:0 0 2px;display:flex;overflow-x:auto}.VisrYW_cardShot{object-fit:contain;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:132px;height:88px;display:block}.VisrYW_lightbox{z-index:10000;cursor:zoom-out;background:#000000d9;justify-content:center;align-items:center;display:flex;position:fixed;top:0;bottom:0;left:0;right:0}.VisrYW_lightboxImg{object-fit:contain;cursor:default;border-radius:4px;max-width:90vw;max-height:85vh}.VisrYW_lightboxClose{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:36px;height:36px;font-size:22px;line-height:1;display:grid;position:absolute;top:16px;right:16px}.VisrYW_lightboxClose:hover{background:#ffffff38}.VisrYW_lightboxNav{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:44px;height:44px;display:grid;position:absolute;top:50%;transform:translateY(-50%)}.VisrYW_lightboxNav:hover{background:#ffffff38}.VisrYW_lightboxPrev{left:16px}.VisrYW_lightboxNext{right:16px}.VisrYW_lightboxDots{gap:8px;display:flex;position:absolute;bottom:20px;left:50%;transform:translate(-50%)}.VisrYW_lightboxDot{cursor:pointer;background:#fff6;border-radius:99px;width:7px;height:7px}.VisrYW_lightboxDotOn{background:#fff}.VisrYW_cmd{background:var(--dsw-alias-bg-layer-2,#f3f4f6);word-break:break-all;border-radius:6px;margin:8px 0 0;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:18px}.VisrYW_warnLine{color:var(--dsw-alias-state-warn-primary,#b45309);flex-wrap:wrap;align-items:center;gap:4px;margin:0;font-size:12px;font-weight:600;line-height:18px;display:flex}.VisrYW_modalNote{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:4px;margin:12px 0 0;font-size:12px;line-height:18px;display:flex}.VisrYW_grid{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;display:grid}.VisrYW_masonry{align-items:flex-start;gap:10px;display:flex}.VisrYW_masonryCol{flex-direction:column;flex:1;gap:10px;min-width:0;display:flex}.VisrYW_masonry>.VisrYW_masonryCol>*{align-self:stretch;min-width:0}@media (max-width:680px){.VisrYW_masonry{flex-direction:column}.VisrYW_masonryCol{width:100%}.VisrYW_grid{grid-template-columns:minmax(0,1fr)}}.VisrYW_swatches{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;gap:0;height:34px;display:flex;overflow:hidden}.VisrYW_themesGrid{margin-bottom:12px}.VisrYW_swatches i{flex:1}.VisrYW_themeToolbar{grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:8px;padding:0 4px 12px;display:grid}.VisrYW_themeSearch{box-sizing:border-box;width:100%;min-width:0}.VisrYW_themeToolbarActions{justify-content:flex-end;align-items:center;gap:8px;display:flex}.VisrYW_themeFullscreenBtn.VisrYW_themeFullscreenBtn{width:28px;min-width:28px;padding:0}.VisrYW_themeResultBar{min-height:24px;color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;padding:0 4px 8px;font-size:12px;line-height:18px;display:flex}.VisrYW_themeGallery{grid-template-columns:repeat(4,minmax(0,1fr));align-items:stretch;gap:10px;display:grid}.VisrYW_themeCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);border-radius:8px;flex-direction:column;min-width:0;transition:border-color .16s cubic-bezier(.16,1,.3,1),box-shadow .16s cubic-bezier(.16,1,.3,1),transform .16s cubic-bezier(.16,1,.3,1);display:flex;overflow:hidden}.VisrYW_themeCard:hover{border-color:var(--dsw-alias-border-l3,#d9dde3);box-shadow:var(--dsw-shadow-lv1,0 4px 12px #1f232814);transform:translateY(-1px)}.VisrYW_themeCover{aspect-ratio:16/10;border:0;border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;color:var(--dsw-alias-label-secondary,#6b7280);cursor:zoom-in;border-radius:0;padding:0;display:block;position:relative;overflow:hidden}.VisrYW_themeCover img{object-fit:contain;background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;height:100%;transition:transform .18s cubic-bezier(.16,1,.3,1);display:block}.VisrYW_themeCover:hover img{transform:scale(1.012)}.VisrYW_themeCover:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4f6ef7);outline-offset:-3px}.VisrYW_themeCoverEmpty{cursor:default;color:var(--dsw-alias-label-tertiary,#8b93a1);flex-direction:column;justify-content:center;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.VisrYW_themePreviewAction,.VisrYW_themePreviewCount{color:#fff;-webkit-backdrop-filter:blur(8px);background:#14181fc7;border:1px solid #ffffff57;border-radius:4px;align-items:center;height:24px;padding:0 8px;font-size:11px;line-height:16px;display:inline-flex;position:absolute;bottom:8px}.VisrYW_themePreviewAction{gap:4px;right:8px}.VisrYW_themePreviewCount{left:8px}.VisrYW_themeCardBody{flex-direction:column;flex:1;gap:8px;padding:12px;display:flex}.VisrYW_themeCardHead{align-items:flex-start;gap:8px;min-width:0;display:flex}.VisrYW_themeIdentity{flex:1;min-width:0}.VisrYW_themeStatus,.VisrYW_themeStatusMuted{white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:22px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.VisrYW_themeStatus{background:var(--dsw-alias-state-success-tertiary,#16a34a1a);color:var(--dsw-alias-state-success-primary,#15803d)}.VisrYW_themeStatusMuted{background:var(--dsw-alias-bg-layer-2,#f3f4f6);color:var(--dsw-alias-label-secondary,#6b7280)}.VisrYW_themeDescription{min-height:36px;color:var(--dsw-alias-label-tertiary,#8b93a1);-webkit-line-clamp:3;-webkit-box-orient:vertical;margin:0;font-size:12px;line-height:18px;display:-webkit-box;overflow:hidden}.VisrYW_themeCardFooter{justify-content:space-between;align-items:center;gap:8px;margin-top:auto;padding-top:4px;display:flex}.VisrYW_themeLifecycle{min-width:0;color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:18px;overflow:hidden}.VisrYW_themeActions{flex-wrap:wrap;justify-content:flex-end;align-items:center;gap:8px;margin-left:auto;display:flex}@container (width<=900px){.VisrYW_themeGallery{grid-template-columns:repeat(3,minmax(0,1fr))}}@container (width<=680px){.VisrYW_themeGallery{grid-template-columns:repeat(2,minmax(0,1fr))}}@container (width<=460px){.VisrYW_themeGallery{grid-template-columns:minmax(0,1fr)}}@container (width<=420px){.VisrYW_sub{grid-template-columns:minmax(0,1fr) auto;align-items:start;gap:2px 8px;display:grid}.VisrYW_sub>span:first-child{grid-area:1/1}.VisrYW_sub>.VisrYW_grow{display:none}.VisrYW_submitLink{grid-area:2/1}.VisrYW_exportLogBtn{flex-shrink:0;grid-area:1/2/span 2}.VisrYW_themeToolbar{grid-template-columns:minmax(0,1fr)}.VisrYW_themeCardHead{flex-wrap:wrap}.VisrYW_themeStatus,.VisrYW_themeStatusMuted{order:3}}@container (width<=280px){.VisrYW_themeCardFooter{flex-direction:column;align-items:flex-start}.VisrYW_themeActions{justify-content:flex-start;width:100%;margin-left:0}}@media (max-width:560px){[role=dialog]:has([data-dsh-market-root])>nav{display:none}[role=dialog]:has([data-dsh-market-root])>div{flex:100%;width:100%;min-width:0}}[role=dialog]:has([data-dsh-market-fullscreen=true]){border-radius:0;width:100vw;max-width:none;height:100vh;max-height:none;position:fixed;top:0;bottom:0;left:0;right:0}@media (prefers-reduced-motion:reduce){.VisrYW_themeCard,.VisrYW_themeCover img{transition:none}.VisrYW_themeCard:hover{transform:none}}.VisrYW_card{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;align-self:start;gap:12px;padding:12px 14px;display:flex}.VisrYW_row1{align-items:flex-start;gap:10px;min-width:0;display:flex}.VisrYW_cardAction{flex-shrink:0;align-items:center;display:inline-flex}.VisrYW_installBtn.VisrYW_installBtn{min-width:64px}.VisrYW_av{color:#fff;object-fit:cover;background:var(--dsw-alias-bg-layer-2,#f3f4f6);border-radius:50%;flex-shrink:0;place-items:center;width:16px;height:16px;font-size:9px;font-weight:700;display:grid}.VisrYW_nm{text-overflow:ellipsis;white-space:nowrap;font-size:15px;font-weight:600;line-height:22px;overflow:hidden}.VisrYW_nmLink{color:inherit;text-decoration:none;display:block}.VisrYW_nmLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.VisrYW_repoMark{color:var(--dsw-alias-label-tertiary,#8b93a1);vertical-align:-1px;flex-shrink:0;margin-left:5px}.VisrYW_nmLink:hover .VisrYW_repoMark{color:var(--dsw-alias-brand-primary,#4f6ef7)}.VisrYW_byline{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.VisrYW_meta{color:var(--dsw-alias-label-secondary,#9ca3af);margin-top:2px;font-size:11px}.VisrYW_metaInline{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px}.VisrYW_owner{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:44px;font-size:11px;overflow:hidden}.VisrYW_desc{color:var(--dsw-alias-label-tertiary,#8b93a1);margin:0;font-size:12px;line-height:18px}.VisrYW_descClamp{-webkit-line-clamp:5;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.VisrYW_descToggle{width:20px;height:16px;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;background:0 0;border:none;justify-content:center;align-items:center;margin-top:2px;padding:0;display:flex}.VisrYW_descToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.VisrYW_foot{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.VisrYW_foot .VisrYW_metaInline,.VisrYW_foot .VisrYW_src{white-space:nowrap}.VisrYW_grow{flex:1}.VisrYW_titleRow{align-items:center;gap:10px;display:flex}.VisrYW_version{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px;line-height:20px}.VisrYW_repoLink{color:var(--dsw-alias-label-tertiary,#8b93a1);flex-shrink:0;font-size:12px;line-height:20px;text-decoration:none}.VisrYW_repoLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.VisrYW_noteRow{flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex}.VisrYW_noteMine{color:var(--dsw-alias-label-primary,#1f2328)}.VisrYW_noteToggle{font:inherit;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;white-space:nowrap;background:0 0;border:none;flex-shrink:0;padding:0;font-size:11px;line-height:16px}.VisrYW_noteToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.VisrYW_noteAction{color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:4px;align-items:center;padding:0 5px;font-weight:600;text-decoration:none;display:inline-flex}.VisrYW_noteAction:hover{color:var(--dsw-alias-label-primary,#1f2328);border-color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:none}.VisrYW_noteEdit{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.VisrYW_noteInput{flex:1;min-width:160px}.VisrYW_descTight{min-height:0}.VisrYW_src{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px;text-decoration:none}.VisrYW_src:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.VisrYW_dot{vertical-align:2px;margin-left:5px}.VisrYW_act{flex-wrap:wrap;align-items:center;gap:6px;margin-top:6px;font-size:11px;display:flex}.VisrYW_actLive{color:var(--dsw-alias-state-success-primary,#16a34a);align-items:center;gap:4px;font-weight:600;display:inline-flex}.VisrYW_actWarn{color:var(--dsw-alias-state-warn-primary,#b45309);align-items:center;gap:4px;font-weight:600;display:inline-flex}.VisrYW_actBroken{color:var(--dsw-alias-state-error-primary,#dc2626);align-items:center;gap:4px;font-weight:600;display:inline-flex}.VisrYW_actWhy{color:var(--dsw-alias-label-secondary,#6b7280);margin-top:2px}.VisrYW_loading{color:var(--dsw-alias-label-secondary,#9ca3af);flex-direction:column;align-items:center;gap:12px;padding:48px;font-size:13px;display:flex}.VisrYW_spin{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;animation:.8s linear infinite VisrYW_sp;display:inline-flex}.VisrYW_logoMark{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;display:inline-flex}.VisrYW_logoPlug{transform-box:fill-box;transform-origin:50%;animation:1.5s cubic-bezier(.4,0,.2,1) infinite VisrYW_dshmPlug}@keyframes VisrYW_dshmPlug{0%,12%{transform:rotate(9deg)}45%,62%{transform:translate(-1.28px,1.27px)rotate(0)}95%,to{transform:rotate(9deg)}}@media (prefers-reduced-motion:reduce){.VisrYW_logoPlug,.VisrYW_spin{animation:1.5s ease-in-out infinite VisrYW_dshmPlugFade}}@keyframes VisrYW_dshmPlugFade{0%,to{opacity:1}50%{opacity:.35}}@keyframes VisrYW_sp{to{transform:rotate(360deg)}}.VisrYW_progress{background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:8px;flex-wrap:wrap;align-items:center;gap:9px;margin:0;padding:8px 12px;font-size:12px;display:flex}.VisrYW_bar{background:var(--dsw-alias-border-l1,#e5e7eb);border-radius:99px;width:100%;height:4px;overflow:hidden}.VisrYW_barFill{background:var(--dsw-alias-brand-primary,#4f6ef7);border-radius:99px;height:100%;transition:width .6s}.VisrYW_barWave{width:30%;animation:1.2s ease-in-out infinite VisrYW_dshmSlide}@keyframes VisrYW_dshmSlide{0%{margin-left:-30%}to{margin-left:100%}}.VisrYW_irow .VisrYW_progress{margin-top:8px}.VisrYW_progress code{text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.VisrYW_empty{color:var(--dsw-alias-label-secondary,#9ca3af);text-align:center;padding:32px;font-size:13px}.VisrYW_err{color:var(--dsw-alias-state-error-primary,#dc2626);white-space:pre-wrap;word-break:break-all;margin:8px 0;font-size:12px}.VisrYW_cardBlocked{border-color:var(--dsw-alias-state-error-primary,#dc2626)}.VisrYW_conflictHead{align-items:flex-start;gap:8px;display:flex}.VisrYW_conflictIcon{color:var(--dsw-alias-state-error-primary,#dc2626);flex-shrink:0;margin-top:1px}.VisrYW_conflictTitle{color:var(--dsw-alias-state-error-primary,#dc2626);font-size:13px;font-weight:600;line-height:18px}.VisrYW_conflictBody{margin:0;font-size:12px;line-height:19px}.VisrYW_roster{background:var(--dsw-alias-border-l2,#e5e7eb);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-direction:column;gap:1px;display:flex;overflow:hidden}.VisrYW_rosterRow{background:var(--dsw-alias-bg-layer-1,#fff);align-items:center;gap:8px;padding:7px 10px;display:flex}.VisrYW_rosterMain{flex-direction:column;min-width:0;display:flex}.VisrYW_rosterName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;font-weight:600;overflow:hidden}.VisrYW_rosterAuthor{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;overflow:hidden}.VisrYW_rosterTag{border-radius:4px;flex-shrink:0;margin-left:auto;padding:1px 6px;font-size:10.5px;font-weight:600}.VisrYW_rosterTagKeep{color:var(--dsw-alias-state-success-primary,#16a34a);background:#16a34a1f}.VisrYW_rosterTagDrop{color:var(--dsw-alias-state-error-primary,#dc2626);background:#dc26261f}.VisrYW_rosterRowOut .VisrYW_rosterName{text-decoration:line-through}.VisrYW_rosterRowOut{opacity:.62}.VisrYW_rosterSplit{background:var(--dsw-alias-border-l2,#e5e7eb);height:1px}.VisrYW_reassure{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:5px;margin:0;font-size:11.5px;line-height:17px;display:flex}.VisrYW_reassureOk{color:var(--dsw-alias-state-success-primary,#16a34a);flex-shrink:0}.VisrYW_conflictWhy{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;margin-top:2px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:17px}.VisrYW_conflictWhyText{margin-top:5px;font-family:-apple-system,BlinkMacSystemFont,PingFang SC,sans-serif}.VisrYW_choices{flex-direction:column;gap:7px;display:flex}.VisrYW_choice{text-align:left;font:inherit;cursor:pointer;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:9px;align-items:flex-start;gap:9px;padding:9px 11px;display:flex}.VisrYW_choice:has(input:disabled){cursor:default;opacity:.6}.VisrYW_choiceOn{border-color:var(--dsw-alias-brand-primary,#4f6ef7);background:var(--dsw-alias-bg-layer-2,#f5f7ff)}.VisrYW_choiceRadio{width:13px;height:13px;accent-color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;margin:2px 0 0}.VisrYW_choiceMain{flex-direction:column;gap:3px;min-width:0;display:flex}.VisrYW_choiceTitle{font-size:12px;font-weight:600;line-height:17px}.VisrYW_choiceNote{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px;line-height:16px}.VisrYW_choiceSafe{color:var(--dsw-alias-state-success-primary,#16a34a)}.VisrYW_stateTag{white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-height:20px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:5px;flex-shrink:0;align-items:center;gap:5px;padding:1px 7px;font-size:11px;line-height:16px;display:inline-flex}.VisrYW_stateTag[data-on=true]{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.VisrYW_stateDot{background:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:999px;flex:none;width:6px;height:6px}.VisrYW_stateDot[data-on=true]{background:var(--dsw-alias-state-success-primary,#16a34a)}.VisrYW_metaTag{text-overflow:ellipsis;white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:0;max-width:100%;min-height:20px;color:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:5px;flex-shrink:1;padding:1px 7px;font-size:11px;line-height:18px;display:inline-block;overflow:hidden}.VisrYW_metaTagOk{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.VisrYW_nameLink{color:inherit;text-decoration:none}.VisrYW_irowName{text-overflow:clip;flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex;overflow:visible}.VisrYW_irowNameText{overflow-wrap:anywhere;white-space:normal;min-width:0}.VisrYW_irowName>.VisrYW_owner{flex:none}.VisrYW_nameLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.VisrYW_opWrap{flex-shrink:0;display:inline-flex;position:relative}.VisrYW_opEntry{font:inherit;cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:7px;align-items:center;gap:6px;padding:4px 10px;font-size:12px;display:inline-flex;position:relative}.VisrYW_opEntryQuiet{color:var(--dsw-alias-label-secondary,#6b7280);background:0 0;border-color:#0000}.VisrYW_opEntryAlert{border-color:var(--dsw-alias-state-error-primary,#dc2626);color:var(--dsw-alias-state-error-primary,#dc2626)}.VisrYW_opDot{background:var(--dsw-alias-state-error-primary,#dc2626);border-radius:99px;width:8px;height:8px;position:absolute;top:-3px;right:-3px}.VisrYW_opPanel{z-index:40;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:12px;width:460px;max-width:86vw;max-height:70vh;position:absolute;top:calc(100% + 6px);right:0;overflow-y:auto;box-shadow:0 20px 52px #00000047}.VisrYW_opHead{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:center;gap:8px;padding:9px 14px;display:flex}.VisrYW_opPanelTitle{font-size:12.5px;font-weight:600}.VisrYW_opCloseBtn.VisrYW_opCloseBtn{min-width:0;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.VisrYW_opAggregate{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f7f8fa);padding:9px 14px}.VisrYW_opAggregateTop{font-variant-numeric:tabular-nums;font-size:12px;font-weight:600}.VisrYW_opAggregateHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:10.5px}.VisrYW_opRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-start;gap:9px;padding:9px 14px;display:flex}.VisrYW_opRow:last-child{border-bottom:none}.VisrYW_opRowAlert{background:#dc26260f}.VisrYW_opIcon{flex-shrink:0;place-items:center;width:14px;margin-top:1px;display:grid}.VisrYW_opQueuedIcon{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px}.VisrYW_opMain{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.VisrYW_opTop{align-items:baseline;gap:6px;min-width:0;display:flex}.VisrYW_opVerb{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:12px}.VisrYW_opName{text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:600;overflow:hidden}.VisrYW_opStatus{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;font-size:10.5px;line-height:16px}.VisrYW_opStatusBad{color:var(--dsw-alias-state-error-primary,#dc2626)}.VisrYW_opActions{flex-shrink:0;align-items:center;gap:6px;margin-top:1px;display:flex}.VisrYW_opDecision{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;margin-top:8px;padding-top:8px;display:flex}.VisrYW_opDecisionFoot{align-items:center;gap:8px;display:flex}.VisrYW_conflictDetailsToggle{font:inherit;cursor:pointer;color:var(--dsw-alias-label-tertiary,#8b93a1);background:0 0;border:none;align-items:center;gap:4px;padding:2px 0;font-size:11px;display:inline-flex}.VisrYW_conflictDetailsToggle:hover{color:var(--dsw-alias-label-secondary,#6b7280)}.VisrYW_opEmpty{text-align:center;color:var(--dsw-alias-label-secondary,#6b7280);padding:30px 14px;font-size:12px}.VisrYW_opEmptyHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:11px}.VisrYW_cardBlockedMark{font:inherit;cursor:pointer;color:var(--dsw-alias-state-error-primary,#dc2626);border:1px solid var(--dsw-alias-state-error-primary,#dc2626);background:#dc262614;border-radius:7px;align-items:center;gap:5px;padding:4px 9px;font-size:11px;display:inline-flex}.VisrYW_dangerBtn.VisrYW_dangerBtn{color:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626)}.VisrYW_dangerBtn.VisrYW_dangerBtn:hover:not(:disabled){background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.VisrYW_dangerArmed.VisrYW_dangerArmed{background:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.VisrYW_retryBtn{margin-top:4px}.VisrYW_irow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:10px;flex-direction:column;gap:10px;min-width:0;padding:12px 14px;display:flex}.VisrYW_irowActions{flex-wrap:wrap;justify-content:flex-start;align-items:center;gap:8px;min-width:0;display:flex}.VisrYW_irowTrailing{flex-wrap:nowrap;align-items:center;gap:8px;min-width:0;display:inline-flex}.VisrYW_irowMissing{filter:grayscale();opacity:.5}.VisrYW_irow>.VisrYW_src,.VisrYW_irow>.VisrYW_owner,.VisrYW_irow button{white-space:nowrap;flex-shrink:0}.VisrYW_tabSearchRow{padding:0 4px 6px;display:flex}.VisrYW_tabSearch{width:100%}.VisrYW_spec{color:var(--dsw-alias-label-secondary,#9ca3af);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:11px}.VisrYW_specTag{white-space:nowrap;border-radius:4px;flex-shrink:0;align-items:center;height:16px;padding:0 5px;font-size:10px;font-weight:600;display:inline-flex}.VisrYW_specTagGit{color:#0b7285;background:#12a3c41f}.VisrYW_specTagFile{color:#b07d1b;background:#f0b42924}.VisrYW_backupCheckList .VisrYW_grow{white-space:nowrap;text-overflow:ellipsis;flex:70%;min-width:0;overflow:hidden}.VisrYW_backupCheckList .VisrYW_spec{text-align:right;white-space:nowrap;text-overflow:ellipsis;flex:0 30%;max-width:30%;overflow:hidden}.VisrYW_staleAction{margin-top:8px}.VisrYW_pct{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:11px;font-weight:600}.VisrYW_pager{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;margin:16px 0 4px;display:flex}.VisrYW_pagerPages{flex-wrap:wrap;flex:1;justify-content:center;align-items:center;gap:6px;min-width:0;display:flex}.VisrYW_pageEllipsis{color:var(--dsw-alias-label-secondary,#9ca3af);padding:0 2px;font-size:12px}.VisrYW_pageInfo{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;font-size:12px}.VisrYW_depBadge{border:1px solid var(--dsw-alias-state-warn-primary,#b45309);color:var(--dsw-alias-state-warn-primary,#b45309);white-space:nowrap;border-radius:4px;flex-shrink:0;margin-left:6px;padding:1px 6px;font-size:11px;font-weight:600;line-height:16px}.VisrYW_deprecate{color:var(--dsw-alias-state-warn-primary,#b45309);background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;margin:0;padding:8px 10px;font-size:12px;line-height:18px}.VisrYW_deprecate a{color:var(--dsw-alias-state-warn-primary,#b45309);text-decoration:underline}.VisrYW_deprecate .VisrYW_src{margin-left:8px}.VisrYW_depLine{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.VisrYW_switch{border:1px solid var(--dsw-alias-border-l2,#d9dde3);background:var(--dsw-alias-bg-layer-2,#e5e7eb);cursor:pointer;border-radius:99px;flex-shrink:0;width:38px;height:22px;padding:0;transition:background .15s,border-color .15s;position:relative}.VisrYW_switchOn{background:var(--dsw-alias-state-success-primary,#16a34a);border-color:var(--dsw-alias-state-success-primary,#16a34a)}.VisrYW_switchMixed{background:var(--dsw-alias-state-warn-primary,#b45309);border-color:var(--dsw-alias-state-warn-primary,#b45309)}.VisrYW_switchKnob{background:#fff;border-radius:99px;width:16px;height:16px;transition:left .15s;position:absolute;top:2px;left:2px;box-shadow:0 1px 2px #00000040}.VisrYW_switchOn .VisrYW_switchKnob,.VisrYW_switchMixed .VisrYW_switchKnob{left:18px}.VisrYW_switch:disabled{opacity:.5;cursor:default}.VisrYW_viewBar{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;align-items:center;gap:2px;width:fit-content;margin-bottom:12px;padding:2px;display:flex}.VisrYW_viewBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-radius:6px;padding:4px 10px;font-size:12px;line-height:18px}.VisrYW_viewBtn:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.VisrYW_viewOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.VisrYW_groupRow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;margin-bottom:10px;padding:12px 14px}.VisrYW_groupHead{align-items:center;gap:10px;min-width:0;display:flex}.VisrYW_groupName{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.VisrYW_groupActions{flex-shrink:0;align-items:center;gap:6px;display:flex}.VisrYW_groupMembers{flex-direction:column;gap:6px;margin-top:10px;display:flex}.VisrYW_groupMember{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:12px;line-height:18px;display:flex}.VisrYW_groupMember .VisrYW_nm{flex:1;min-width:0;font-size:12px}.VisrYW_groupAddPanel{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:6px;margin-top:10px;padding-top:10px;display:flex}.VisrYW_groupCreate{align-items:center;gap:8px;margin-bottom:10px;display:flex}.VisrYW_inlineInput{flex:1;min-width:120px}.VisrYW_assignRow{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.VisrYW_assignSelect{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#1f2328);font:inherit;border-radius:6px;padding:3px 6px;font-size:12px;line-height:18px}.VisrYW_groupHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px}.VisrYW_sectAction{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:8px;margin:14px 2px 8px;font-size:12px;font-weight:600;display:flex}.VisrYW_backupGrid{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:12px;display:grid}.VisrYW_backupCard{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:10px;padding:16px;display:flex}.VisrYW_backupCard h3{margin:0;font-size:14px}.VisrYW_backupCard p{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.VisrYW_backupActions{flex-wrap:wrap;gap:8px;display:flex;position:relative}.VisrYW_hiddenFile{opacity:0;pointer-events:none;width:1px;height:1px;position:absolute}.VisrYW_backupInput{box-sizing:border-box;width:100%}.VisrYW_backupCheck{cursor:pointer;align-items:center;gap:6px;font-size:12px;display:flex}.VisrYW_backupWarn{margin:0;font-size:12px;line-height:18px;color:var(--dsw-alias-state-warn-primary,#b45309)!important}.VisrYW_backupMessage{color:var(--dsw-alias-label-secondary,#6b7280);grid-column:1/-1;font-size:12px}.VisrYW_backupCheckList{flex-direction:column;gap:6px;max-height:260px;margin:10px 0 4px;padding-right:4px;display:flex;overflow-y:auto}.VisrYW_backupCheckList .VisrYW_backupCheck{justify-content:space-between;gap:8px}.VisrYW_diagPage{flex-direction:column;gap:12px;height:100%;min-height:0;display:flex;overflow-y:auto}.VisrYW_diagSummary{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-wrap:wrap;align-items:center;gap:12px;padding:10px 14px;font-size:12px;display:flex}.VisrYW_diagSummaryItem{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;align-items:center;gap:6px;display:inline-flex}.VisrYW_diagSummaryMeta{color:var(--dsw-alias-label-tertiary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;max-width:320px;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.VisrYW_diagSection{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:8px;padding:12px 14px;display:flex}.VisrYW_diagSection h3{color:var(--dsw-alias-label-primary,#1f2328);margin:0;font-size:13px;font-weight:600}.VisrYW_diagCount{color:var(--dsw-alias-label-tertiary,#9ca3af);font-size:11px;font-weight:400}.VisrYW_diagEmpty{color:var(--dsw-alias-label-secondary,#9ca3af);padding:8px 0;font-size:12px}.VisrYW_diagBundle{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);flex-direction:column;gap:6px;padding-top:8px;display:flex}.VisrYW_diagBundle:first-of-type{border-top:none;padding-top:0}.VisrYW_diagRow{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;font-size:12px;line-height:18px;display:flex}.VisrYW_diagMeta{align-items:baseline;gap:8px;min-width:0;font-size:12px;display:flex}.VisrYW_diagKey{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;min-width:64px;font-size:11px}.VisrYW_diagVal{color:var(--dsw-alias-label-primary,#1f2328);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:12px;font-weight:500}.VisrYW_diagIndex{background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:18px;height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;justify-content:center;align-items:center;font-size:11px;font-weight:600;display:inline-flex}.VisrYW_diagArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.VisrYW_diagBadgeOfficial{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.VisrYW_diagBadgeCommunity{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.VisrYW_diagBadgeShadow{background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.VisrYW_diagBadgeWarn{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.VisrYW_diagBadgeInfo{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.VisrYW_diagList{flex-direction:column;gap:6px;display:flex}.VisrYW_sectionOverview{color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;max-width:100%;padding:2px 0 6px;font-size:12px;line-height:18px;overflow:hidden}.VisrYW_diagAlert{color:var(--dsw-alias-state-warn-primary,#b45309)}.VisrYW_ovRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.VisrYW_ovArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.VisrYW_ovByTag{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;text-overflow:ellipsis;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;max-width:260px;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex;overflow:hidden}.VisrYW_ovFrom{color:var(--dsw-alias-label-secondary,#6b7280);text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;overflow:hidden}.VisrYW_orphRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.VisrYW_orphBadge{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.VisrYW_dragHandle{width:20px;height:20px;color:var(--dsw-alias-label-tertiary,#9ca3af);cursor:grab;-webkit-user-select:none;user-select:none;flex-shrink:0;justify-content:center;align-items:center;font-size:12px;line-height:20px;display:inline-flex}.VisrYW_dragOver{outline:2px dashed var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:2px;background:var(--dsw-alias-bg-layer-2,#f0f2f8);border-radius:8px}.VisrYW_dragging{opacity:.45;background:var(--dsw-alias-bg-layer-2,#f3f4f6)}.VisrYW_collapseHead{font:inherit;color:var(--dsw-alias-label-primary,#1f2328);cursor:pointer;text-align:left;background:0 0;border:none;align-items:center;gap:8px;width:100%;padding:0;font-size:13px;font-weight:600;display:flex}.VisrYW_collapseIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;display:inline-flex}.VisrYW_collapseTitle{flex:1;min-width:0}.VisrYW_collapseBody{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);overflow-wrap:anywhere;flex-direction:column;gap:10px;min-width:0;margin-top:8px;padding-top:10px;display:flex}.VisrYW_orderPanel{flex-direction:column;gap:10px;min-width:0;display:flex}.VisrYW_panelNote{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.VisrYW_panelActions{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.VisrYW_presetList{flex-direction:column;gap:6px;min-width:0;display:flex}.VisrYW_presetRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:6px;min-width:0;max-width:100%;padding:8px 10px;font-size:12px;line-height:18px;display:flex}.VisrYW_presetName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:13px;font-weight:600;overflow:hidden}.VisrYW_snapList{flex-direction:column;gap:6px;min-width:0;display:flex}.VisrYW_snapRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:8px;padding:10px 12px;font-size:12px;line-height:18px;display:flex}.VisrYW_snapMeta{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;display:flex}.VisrYW_snapConfirmText{color:var(--dsw-alias-state-warn-primary,#b45309);margin:0;font-size:12px;line-height:18px}.VisrYW_confirmRow{flex-wrap:wrap;align-items:center;gap:6px;display:inline-flex}.VisrYW_fixFallback{flex-direction:column;gap:6px;margin:8px 0;display:flex}.VisrYW_fixFallbackText{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);resize:vertical;white-space:pre-wrap;word-break:break-all;border-radius:6px;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:16px}.VisrYW_setCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-3,#fff);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.VisrYW_setCard:hover{border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.VisrYW_setCardOpen{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.VisrYW_setHeader{-webkit-appearance:none;appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.VisrYW_setHeader:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:-2px}.VisrYW_setHeadText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.VisrYW_setName{color:var(--dsw-alias-label-primary,#1f2328);font-size:15px;font-weight:600;line-height:1.4}.VisrYW_setDesc{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:13px;line-height:1.5}.VisrYW_setChevron{color:var(--dsw-alias-label-tertiary,#8b93a1);flex:none;transition:transform .16s;display:inline-flex}.VisrYW_setChevronOpen{transform:rotate(180deg)}.VisrYW_setBody{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);margin:0 16px;padding-bottom:8px}.VisrYW_setRow{align-items:center;gap:12px;padding:12px 0;display:flex}.VisrYW_setRow+.VisrYW_setRow{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb)}.VisrYW_setLabelBox{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.VisrYW_setLabel{font-size:13px;line-height:20px}.VisrYW_setHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px;line-height:18px}.VisrYW_setConfirm{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;padding:12px 0 4px;display:flex}.VisrYW_setCheck{cursor:pointer;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.VisrYW_setActions{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.VisrYW_setDanger{color:var(--dsw-alias-state-error-primary,#dc2626)}.VisrYW_setSeg{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-shrink:0;gap:2px;padding:2px;display:inline-flex}.VisrYW_setSegBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;background:0 0;border:none;border-radius:6px;padding:3px 10px;font-size:12px;line-height:18px}.VisrYW_setSegBtn:disabled{cursor:default;opacity:.5}.VisrYW_setSegOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.VisrYW_setBetaTag{background:var(--dsw-alias-bg-module-platform,#eef0f4);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;margin-left:6px;padding:0 6px;font-size:11px;font-weight:600;line-height:17px}.VisrYW_commentsLink{cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-secondary,#9ca3af);background:0 0;border:0;padding:0;font-size:11px;line-height:16px}.VisrYW_commentsLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.VisrYW_commentsNote{color:var(--dsw-alias-label-secondary,#9ca3af);margin:0 0 8px;font-size:11px;line-height:16px}.VisrYW_commentsStatus{color:var(--dsw-alias-label-secondary,#9ca3af);margin:0;font-size:12px}.VisrYW_commentsStatus:empty{display:none}.VisrYW_commentsError{color:var(--dsw-alias-label-primary,#1f2328);margin:0 0 8px;font-size:12px}.VisrYW_commentsFail{flex-direction:column;align-items:flex-start;gap:8px;padding:12px 0;display:flex}.VisrYW_commentsMount{width:100%;min-height:240px;max-height:56vh;overflow:auto}.VisrYW_commentsMount iframe{width:100%}.VisrYW_notesLink{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;text-align:left;background:0 0;border:none;margin:2px 0 0;padding:0;font-size:12px;line-height:18px;display:block}.VisrYW_notesLink:hover{color:var(--dsw-alias-label-primary,#1f2328)}.VisrYW_notesBody{flex-direction:column;gap:8px;min-width:0;display:flex}.VisrYW_notesRange{align-items:center;gap:8px;margin-bottom:4px;font-size:12px;line-height:18px;display:flex}.VisrYW_notesArrow{color:var(--dsw-alias-label-tertiary,#8b93a1)}.VisrYW_notesMeta{letter-spacing:.02em;text-transform:uppercase;color:var(--dsw-alias-label-secondary,#6b7280);flex-wrap:wrap;align-items:baseline;gap:6px;margin-top:12px;font-size:12px;line-height:18px;display:flex}.VisrYW_notesPre{white-space:pre-wrap;word-break:break-word;background:var(--dsw-alias-bg-layer-2,#eef0f4);border-radius:8px;max-height:40vh;margin:0;padding:10px 12px;font-size:13px;line-height:20px;overflow:auto}.VisrYW_notesList{flex-direction:column;gap:6px;margin:0;padding-left:18px;font-size:13px;line-height:20px;display:flex}.VisrYW_notesRendered{flex-direction:column;gap:6px;min-width:0;display:flex}.VisrYW_notesH{margin-top:6px;font-size:13px;font-weight:650;line-height:20px}.VisrYW_notesP{font-size:13px;line-height:20px}.VisrYW_notesCode{font-family:var(--dsw-alias-font-mono,ui-monospace,monospace);background:var(--dsw-alias-bg-layer-2,#eef0f4);border-radius:5px;padding:1px 5px;font-size:12px}.VisrYW_notesList{flex-direction:column;margin:0;padding:0;list-style:none;display:flex}.VisrYW_notesRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:baseline;gap:12px;padding:6px 0;display:flex}.VisrYW_notesRow:last-child{border-bottom:none}.VisrYW_notesDate{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px}.VisrYW_notesMsg{word-break:break-word;word-break:break-word;-webkit-line-clamp:3;-webkit-box-orient:vertical;min-width:0;font-size:13px;line-height:20px;display:-webkit-box;overflow:hidden}.VisrYW_notesSha{color:var(--dsw-alias-label-secondary,#6b7280);font-variant-numeric:tabular-nums;flex-shrink:0;margin-left:auto;font-size:12px;text-decoration:none}.VisrYW_notesSha:hover{color:var(--dsw-alias-label-primary,#1f2328);text-decoration:underline}.VisrYW_notesVer{color:inherit;font-weight:600;text-decoration:none}.VisrYW_notesVer:hover{text-decoration:underline}";
		...
		var Market_module_css_default = {
			"act": "VisrYW_act",
			"actBroken": "VisrYW_actBroken",
			"actLive": "VisrYW_actLive",
			"actWarn": "VisrYW_actWarn",
			"actWhy": "VisrYW_actWhy",
			"assignRow": "VisrYW_assignRow",
			"assignSelect": "VisrYW_assignSelect",
			"av": "VisrYW_av",
			"backupActions": "VisrYW_backupActions",
			"backupCard": "VisrYW_backupCard",
			"backupCheck": "VisrYW_backupCheck",
			"backupCheckList": "VisrYW_backupCheckList",
			"backupGrid": "VisrYW_backupGrid",
			"backupInput": "VisrYW_backupInput",
			"backupMessage": "VisrYW_backupMessage",
			"backupWarn": "VisrYW_backupWarn",
			"banner": "VisrYW_banner",
			"bannerHint": "VisrYW_bannerHint",
			"bannerIcon": "VisrYW_bannerIcon",
			"bar": "VisrYW_bar",
			"barFill": "VisrYW_barFill",
			"barWave": "VisrYW_barWave",
			"body": "VisrYW_body",
			"byline": "VisrYW_byline",
			"card": "VisrYW_card",
			"cardAction": "VisrYW_cardAction",
			"cardBlocked": "VisrYW_cardBlocked",
			"cardBlockedMark": "VisrYW_cardBlockedMark",
			"cardShot": "VisrYW_cardShot",
			"cardShots": "VisrYW_cardShots",
			"cats": "VisrYW_cats",
			"catsCollapsed": "VisrYW_catsCollapsed",
			"catsRow": "VisrYW_catsRow",
			"catsToggle": "VisrYW_catsToggle",
			"catsWrap": "VisrYW_catsWrap",
			"choice": "VisrYW_choice",
			"choiceMain": "VisrYW_choiceMain",
			"choiceNote": "VisrYW_choiceNote",
			"choiceOn": "VisrYW_choiceOn",
			"choiceRadio": "VisrYW_choiceRadio",
			"choices": "VisrYW_choices",
			"choiceSafe": "VisrYW_choiceSafe",
			"choiceTitle": "VisrYW_choiceTitle",
			"cmd": "VisrYW_cmd",
			"collapseBody": "VisrYW_collapseBody",
			"collapseHead": "VisrYW_collapseHead",
			"collapseIcon": "VisrYW_collapseIcon",
			"collapseTitle": "VisrYW_collapseTitle",
			"commentsError": "VisrYW_commentsError",
			"commentsFail": "VisrYW_commentsFail",
			"commentsLink": "VisrYW_commentsLink",
			"commentsMount": "VisrYW_commentsMount",
			"commentsNote": "VisrYW_commentsNote",
			"commentsStatus": "VisrYW_commentsStatus",
			"confirmRow": "VisrYW_confirmRow",
			"conflictBody": "VisrYW_conflictBody",
			"conflictDetailsToggle": "VisrYW_conflictDetailsToggle",
			"conflictHead": "VisrYW_conflictHead",
			"conflictIcon": "VisrYW_conflictIcon",
			"conflictTitle": "VisrYW_conflictTitle",
			"conflictWhy": "VisrYW_conflictWhy",
			"conflictWhyText": "VisrYW_conflictWhyText",
			"dangerArmed": "VisrYW_dangerArmed",
			"dangerBtn": "VisrYW_dangerBtn",
			"depBadge": "VisrYW_depBadge",
			"depLine": "VisrYW_depLine",
			"deprecate": "VisrYW_deprecate",
			"desc": "VisrYW_desc",
			"descClamp": "VisrYW_descClamp",
			"descTight": "VisrYW_descTight",
			"descToggle": "VisrYW_descToggle",
			"diagAlert": "VisrYW_diagAlert",
			"diagArrow": "VisrYW_diagArrow",
			"diagBadgeCommunity": "VisrYW_diagBadgeCommunity",
			"diagBadgeInfo": "VisrYW_diagBadgeInfo",
			"diagBadgeOfficial": "VisrYW_diagBadgeOfficial",
			"diagBadgeShadow": "VisrYW_diagBadgeShadow",
			"diagBadgeWarn": "VisrYW_diagBadgeWarn",
			"diagBundle": "VisrYW_diagBundle",
			"diagCount": "VisrYW_diagCount",
			"diagEmpty": "VisrYW_diagEmpty",
			"diagIndex": "VisrYW_diagIndex",
			"diagKey": "VisrYW_diagKey",
			"diagList": "VisrYW_diagList",
			"diagMeta": "VisrYW_diagMeta",
			"diagPage": "VisrYW_diagPage",
			"diagRow": "VisrYW_diagRow",
			"diagSection": "VisrYW_diagSection",
			"diagSummary": "VisrYW_diagSummary",
			"diagSummaryItem": "VisrYW_diagSummaryItem",
			"diagSummaryMeta": "VisrYW_diagSummaryMeta",
			"diagVal": "VisrYW_diagVal",
			"dot": "VisrYW_dot",
			"dragging": "VisrYW_dragging",
			"dragHandle": "VisrYW_dragHandle",
			"dragOver": "VisrYW_dragOver",
			"dshmPlug": "VisrYW_dshmPlug",
			"dshmPlugFade": "VisrYW_dshmPlugFade",
			"dshmSlide": "VisrYW_dshmSlide",
			"empty": "VisrYW_empty",
			"err": "VisrYW_err",
			"exportLogBtn": "VisrYW_exportLogBtn",
			"fixFallback": "VisrYW_fixFallback",
			"fixFallbackText": "VisrYW_fixFallbackText",
			"foot": "VisrYW_foot",
			"grid": "VisrYW_grid",
			"groupActions": "VisrYW_groupActions",
			"groupAddPanel": "VisrYW_groupAddPanel",
			"groupCreate": "VisrYW_groupCreate",
			"groupHead": "VisrYW_groupHead",
			"groupHint": "VisrYW_groupHint",
			"groupMember": "VisrYW_groupMember",
			"groupMembers": "VisrYW_groupMembers",
			"groupName": "VisrYW_groupName",
			"groupRow": "VisrYW_groupRow",
			"grow": "VisrYW_grow",
			"head": "VisrYW_head",
			"hiddenFile": "VisrYW_hiddenFile",
			"inlineInput": "VisrYW_inlineInput",
			"installBtn": "VisrYW_installBtn",
			"irow": "VisrYW_irow",
			"irowActions": "VisrYW_irowActions",
			"irowMissing": "VisrYW_irowMissing",
			"irowName": "VisrYW_irowName",
			"irowNameText": "VisrYW_irowNameText",
			"irowTrailing": "VisrYW_irowTrailing",
			"lightbox": "VisrYW_lightbox",
			"lightboxClose": "VisrYW_lightboxClose",
			"lightboxDot": "VisrYW_lightboxDot",
			"lightboxDotOn": "VisrYW_lightboxDotOn",
			"lightboxDots": "VisrYW_lightboxDots",
			"lightboxImg": "VisrYW_lightboxImg",
			"lightboxNav": "VisrYW_lightboxNav",
			"lightboxNext": "VisrYW_lightboxNext",
			"lightboxPrev": "VisrYW_lightboxPrev",
			"loading": "VisrYW_loading",
			"logoMark": "VisrYW_logoMark",
			"logoPlug": "VisrYW_logoPlug",
			"masonry": "VisrYW_masonry",
			"masonryCol": "VisrYW_masonryCol",
			"meta": "VisrYW_meta",
			"metaInline": "VisrYW_metaInline",
			"metaTag": "VisrYW_metaTag",
			"metaTagOk": "VisrYW_metaTagOk",
			"modalNote": "VisrYW_modalNote",
			"nameLink": "VisrYW_nameLink",
			"nm": "VisrYW_nm",
			"nmLink": "VisrYW_nmLink",
			"noteAction": "VisrYW_noteAction",
			"noteEdit": "VisrYW_noteEdit",
			"noteInput": "VisrYW_noteInput",
			"noteMine": "VisrYW_noteMine",
			"noteRow": "VisrYW_noteRow",
			"notesArrow": "VisrYW_notesArrow",
			"notesBody": "VisrYW_notesBody",
			"notesCode": "VisrYW_notesCode",
			"notesDate": "VisrYW_notesDate",
			"notesH": "VisrYW_notesH",
			"notesLink": "VisrYW_notesLink",
			"notesList": "VisrYW_notesList",
			"notesMeta": "VisrYW_notesMeta",
			"notesMsg": "VisrYW_notesMsg",
			"notesP": "VisrYW_notesP",
			"notesPre": "VisrYW_notesPre",
			"notesRange": "VisrYW_notesRange",
			"notesRendered": "VisrYW_notesRendered",
			"notesRow": "VisrYW_notesRow",
			"notesSha": "VisrYW_notesSha",
			"notesVer": "VisrYW_notesVer",
			"noteToggle": "VisrYW_noteToggle",
			"okState": "VisrYW_okState",
			"on": "VisrYW_on",
			"opActions": "VisrYW_opActions",
			"opAggregate": "VisrYW_opAggregate",
			"opAggregateHint": "VisrYW_opAggregateHint",
			"opAggregateTop": "VisrYW_opAggregateTop",
			"opCloseBtn": "VisrYW_opCloseBtn",
			"opDecision": "VisrYW_opDecision",
			"opDecisionFoot": "VisrYW_opDecisionFoot",
			"opDot": "VisrYW_opDot",
			"opEmpty": "VisrYW_opEmpty",
			"opEmptyHint": "VisrYW_opEmptyHint",
			"opEntry": "VisrYW_opEntry",
			"opEntryAlert": "VisrYW_opEntryAlert",
			"opEntryQuiet": "VisrYW_opEntryQuiet",
			"opHead": "VisrYW_opHead",
			"opIcon": "VisrYW_opIcon",
			"opMain": "VisrYW_opMain",
			"opName": "VisrYW_opName",
			"opPanel": "VisrYW_opPanel",
			"opPanelTitle": "VisrYW_opPanelTitle",
			"opQueuedIcon": "VisrYW_opQueuedIcon",
			"opRow": "VisrYW_opRow",
			"opRowAlert": "VisrYW_opRowAlert",
			"opStatus": "VisrYW_opStatus",
			"opStatusBad": "VisrYW_opStatusBad",
			"opTop": "VisrYW_opTop",
			"opVerb": "VisrYW_opVerb",
			"opWrap": "VisrYW_opWrap",
			"orderPanel": "VisrYW_orderPanel",
			"orphBadge": "VisrYW_orphBadge",
			"orphRow": "VisrYW_orphRow",
			"ovArrow": "VisrYW_ovArrow",
			"ovByTag": "VisrYW_ovByTag",
			"ovFrom": "VisrYW_ovFrom",
			"ovRow": "VisrYW_ovRow",
			"owner": "VisrYW_owner",
			"pageEllipsis": "VisrYW_pageEllipsis",
			"pageInfo": "VisrYW_pageInfo",
			"pager": "VisrYW_pager",
			"pagerPages": "VisrYW_pagerPages",
			"panelActions": "VisrYW_panelActions",
			"panelNote": "VisrYW_panelNote",
			"pct": "VisrYW_pct",
			"presetList": "VisrYW_presetList",
			"presetName": "VisrYW_presetName",
			"presetRow": "VisrYW_presetRow",
			"progress": "VisrYW_progress",
			"reassure": "VisrYW_reassure",
			"reassureOk": "VisrYW_reassureOk",
			"repoLink": "VisrYW_repoLink",
			"repoMark": "VisrYW_repoMark",
			"retryBtn": "VisrYW_retryBtn",
			"root": "VisrYW_root",
			"roster": "VisrYW_roster",
			"rosterAuthor": "VisrYW_rosterAuthor",
			"rosterMain": "VisrYW_rosterMain",
			"rosterName": "VisrYW_rosterName",
			"rosterRow": "VisrYW_rosterRow",
			"rosterRowOut": "VisrYW_rosterRowOut",
			"rosterSplit": "VisrYW_rosterSplit",
			"rosterTag": "VisrYW_rosterTag",
			"rosterTagDrop": "VisrYW_rosterTagDrop",
			"rosterTagKeep": "VisrYW_rosterTagKeep",
			"row1": "VisrYW_row1",
			"sectAction": "VisrYW_sectAction",
			"sectionOverview": "VisrYW_sectionOverview",
			"setActions": "VisrYW_setActions",
			"setBetaTag": "VisrYW_setBetaTag",
			"setBody": "VisrYW_setBody",
			"setCard": "VisrYW_setCard",
			"setCardOpen": "VisrYW_setCardOpen",
			"setCheck": "VisrYW_setCheck",
			"setChevron": "VisrYW_setChevron",
			"setChevronOpen": "VisrYW_setChevronOpen",
			"setConfirm": "VisrYW_setConfirm",
			"setDanger": "VisrYW_setDanger",
			"setDesc": "VisrYW_setDesc",
			"setHeader": "VisrYW_setHeader",
			"setHeadText": "VisrYW_setHeadText",
			"setHint": "VisrYW_setHint",
			"setLabel": "VisrYW_setLabel",
			"setLabelBox": "VisrYW_setLabelBox",
			"setName": "VisrYW_setName",
			"setRow": "VisrYW_setRow",
			"setSeg": "VisrYW_setSeg",
			"setSegBtn": "VisrYW_setSegBtn",
			"setSegOn": "VisrYW_setSegOn",
			"shot": "VisrYW_shot",
			"shots": "VisrYW_shots",
			"snapConfirmText": "VisrYW_snapConfirmText",
			"snapList": "VisrYW_snapList",
			"snapMeta": "VisrYW_snapMeta",
			"snapRow": "VisrYW_snapRow",
			"sp": "VisrYW_sp",
			"spec": "VisrYW_spec",
			"specTag": "VisrYW_specTag",
			"specTagFile": "VisrYW_specTagFile",
			"specTagGit": "VisrYW_specTagGit",
			"spin": "VisrYW_spin",
			"src": "VisrYW_src",
			"staleAction": "VisrYW_staleAction",
			"star": "VisrYW_star",
			"stateDot": "VisrYW_stateDot",
			"stateTag": "VisrYW_stateTag",
			"stickyHead": "VisrYW_stickyHead",
			"sub": "VisrYW_sub",
			"submitLink": "VisrYW_submitLink",
			"subTabs": "VisrYW_subTabs",
			"swatches": "VisrYW_swatches",
			"switch": "VisrYW_switch",
			"switchKnob": "VisrYW_switchKnob",
			"switchMixed": "VisrYW_switchMixed",
			"switchOn": "VisrYW_switchOn",
			"tab": "VisrYW_tab",
			"tabs": "VisrYW_tabs",
			"tabSearch": "VisrYW_tabSearch",
			"tabSearchRow": "VisrYW_tabSearchRow",
			"tag": "VisrYW_tag",
			"themeActions": "VisrYW_themeActions",
			"themeCard": "VisrYW_themeCard",
			"themeCardBody": "VisrYW_themeCardBody",
			"themeCardFooter": "VisrYW_themeCardFooter",
			"themeCardHead": "VisrYW_themeCardHead",
			"themeCover": "VisrYW_themeCover",
			"themeCoverEmpty": "VisrYW_themeCoverEmpty",
			"themeDescription": "VisrYW_themeDescription",
			"themeFullscreenBtn": "VisrYW_themeFullscreenBtn",
			"themeGallery": "VisrYW_themeGallery",
			"themeIdentity": "VisrYW_themeIdentity",
			"themeLifecycle": "VisrYW_themeLifecycle",
			"themePreviewAction": "VisrYW_themePreviewAction",
			"themePreviewCount": "VisrYW_themePreviewCount",
			"themeResultBar": "VisrYW_themeResultBar",
			"themeSearch": "VisrYW_themeSearch",
			"themesGrid": "VisrYW_themesGrid",
			"themeStatus": "VisrYW_themeStatus",
			"themeStatusMuted": "VisrYW_themeStatusMuted",
			"themeToolbar": "VisrYW_themeToolbar",
			"themeToolbarActions": "VisrYW_themeToolbarActions",
			"title": "VisrYW_title",
			"titleRow": "VisrYW_titleRow",
			"top": "VisrYW_top",
			"topBtn": "VisrYW_topBtn",
			"version": "VisrYW_version",
			"viewBar": "VisrYW_viewBar",
			"viewBtn": "VisrYW_viewBtn",
			"viewOn": "VisrYW_viewOn",
			"warnLine": "VisrYW_warnLine"
		};
		//#endregion
