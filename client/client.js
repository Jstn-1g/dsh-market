window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		*/
		...
		const css = "._V3Dra_root{min-width:0;height:100%;color:var(--dsw-alias-label-primary,#1f2328);flex-direction:column;display:flex;position:relative;container-type:inline-size}._V3Dra_head{flex-direction:column;gap:12px;padding:4px 4px 6px;display:flex}._V3Dra_title{margin:0;font-size:16px;font-weight:500;line-height:24px}._V3Dra_sub{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:8px;margin:0;font-size:12px;line-height:18px;display:flex}._V3Dra_submitLink{color:var(--dsw-alias-label-tertiary,#8b93a1);white-space:nowrap;font-size:11px;line-height:18px;text-decoration:none}._V3Dra_submitLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}._V3Dra_tabs{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-end;gap:2px;display:flex}._V3Dra_tab{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-bottom:2px solid #0000;padding:7px 12px;font-size:13px}._V3Dra_tab._V3Dra_on{color:var(--dsw-alias-brand-primary,#4f6ef7);border-bottom-color:var(--dsw-alias-brand-primary,#4f6ef7);font-weight:600}._V3Dra_subTabs{align-items:flex-end;gap:2px;margin:-4px 0 4px;display:flex}._V3Dra_banner{background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;align-items:center;gap:8px;margin:0;padding:8px 12px;font-size:12px;display:flex}._V3Dra_bannerIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0}._V3Dra_bannerHint{color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:help;display:inline-flex}._V3Dra_body{overflow-anchor:none;flex:1;padding:12px 4px 24px;overflow-x:hidden;overflow-y:auto}._V3Dra_stickyHead{z-index:5;background:var(--dsw-alias-bg-layer-2,#f7f8fa);position:sticky;top:-1px}._V3Dra_stickyHead:before{content:\"\";background:inherit;pointer-events:none;height:14px;position:absolute;bottom:100%;left:0;right:0}._V3Dra_cats{margin:0 -4px 2px;padding:12px 4px 4px}._V3Dra_catsRow{align-items:flex-start;gap:8px;display:flex;position:relative}._V3Dra_star{color:var(--dsw-alias-label-secondary,#9ca3af);white-space:nowrap;flex:none;font-size:11px}._V3Dra_top{z-index:20;display:inline-flex;position:absolute;bottom:18px;right:18px}._V3Dra_topBtn{border-radius:99px;width:38px;height:38px;padding:0}._V3Dra_tag{border:1px solid var(--dsw-alias-border-l3,#d9dde3);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:4px;flex-shrink:0;padding:1px 6px;font-size:11px;line-height:16px}._V3Dra_okState{color:var(--dsw-alias-state-success-primary,#16a34a);white-space:nowrap;font-size:12px;font-weight:600}._V3Dra_catsWrap{flex-wrap:wrap;flex:1;align-items:center;gap:6px;min-width:0;display:flex}._V3Dra_catsCollapsed{max-height:62px;overflow:hidden}._V3Dra_catsToggle._V3Dra_catsToggle{height:26px;min-height:26px;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}._V3Dra_shots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:8px;margin:6px 0 8px;padding:2px 0 6px;display:flex;overflow-x:auto}._V3Dra_shot{object-fit:cover;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:220px;height:150px}._V3Dra_cardShots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:6px;margin:0 0 6px;padding:0 0 2px;display:flex;overflow-x:auto}._V3Dra_cardShot{object-fit:contain;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:132px;height:88px;display:block}._V3Dra_lightbox{z-index:10000;cursor:zoom-out;background:#000000d9;justify-content:center;align-items:center;display:flex;position:fixed;top:0;bottom:0;left:0;right:0}._V3Dra_lightboxImg{object-fit:contain;cursor:default;border-radius:4px;max-width:90vw;max-height:85vh}._V3Dra_lightboxClose{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:36px;height:36px;font-size:22px;line-height:1;display:grid;position:absolute;top:16px;right:16px}._V3Dra_lightboxClose:hover{background:#ffffff38}._V3Dra_lightboxNav{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:44px;height:44px;display:grid;position:absolute;top:50%;transform:translateY(-50%)}._V3Dra_lightboxNav:hover{background:#ffffff38}._V3Dra_lightboxPrev{left:16px}._V3Dra_lightboxNext{right:16px}._V3Dra_lightboxDots{gap:8px;display:flex;position:absolute;bottom:20px;left:50%;transform:translate(-50%)}._V3Dra_lightboxDot{cursor:pointer;background:#fff6;border-radius:99px;width:7px;height:7px}._V3Dra_lightboxDotOn{background:#fff}._V3Dra_cmd{background:var(--dsw-alias-bg-layer-2,#f3f4f6);word-break:break-all;border-radius:6px;margin:8px 0 0;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:18px}._V3Dra_warnLine{color:var(--dsw-alias-state-warn-primary,#b45309);flex-wrap:wrap;align-items:center;gap:4px;margin:0;font-size:12px;font-weight:600;line-height:18px;display:flex}._V3Dra_modalNote{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:4px;margin:12px 0 0;font-size:12px;line-height:18px;display:flex}._V3Dra_grid{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;display:grid}._V3Dra_masonry{align-items:flex-start;gap:10px;display:flex}._V3Dra_masonryCol{flex-direction:column;flex:1;gap:10px;min-width:0;display:flex}._V3Dra_masonry>._V3Dra_masonryCol>*{align-self:stretch;min-width:0}@media (max-width:680px){._V3Dra_masonry{flex-direction:column}._V3Dra_masonryCol{width:100%}._V3Dra_grid{grid-template-columns:minmax(0,1fr)}}._V3Dra_swatches{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;gap:0;height:34px;display:flex;overflow:hidden}._V3Dra_themesGrid{margin-bottom:12px}._V3Dra_swatches i{flex:1}._V3Dra_themeToolbar{grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:8px;padding:0 4px 12px;display:grid}._V3Dra_themeSearch{box-sizing:border-box;width:100%;min-width:0}._V3Dra_themeToolbarActions{justify-content:flex-end;align-items:center;gap:8px;display:flex}._V3Dra_themeFullscreenBtn._V3Dra_themeFullscreenBtn{width:28px;min-width:28px;padding:0}._V3Dra_themeResultBar{min-height:24px;color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;padding:0 4px 8px;font-size:12px;line-height:18px;display:flex}._V3Dra_themeGallery{grid-template-columns:repeat(4,minmax(0,1fr));align-items:stretch;gap:10px;display:grid}._V3Dra_themeCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);border-radius:8px;flex-direction:column;min-width:0;transition:border-color .16s cubic-bezier(.16,1,.3,1),box-shadow .16s cubic-bezier(.16,1,.3,1),transform .16s cubic-bezier(.16,1,.3,1);display:flex;overflow:hidden}._V3Dra_themeCard:hover{border-color:var(--dsw-alias-border-l3,#d9dde3);box-shadow:var(--dsw-shadow-lv1,0 4px 12px #1f232814);transform:translateY(-1px)}._V3Dra_themeCover{aspect-ratio:16/10;border:0;border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;color:var(--dsw-alias-label-secondary,#6b7280);cursor:zoom-in;border-radius:0;padding:0;display:block;position:relative;overflow:hidden}._V3Dra_themeCover img{object-fit:contain;background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;height:100%;transition:transform .18s cubic-bezier(.16,1,.3,1);display:block}._V3Dra_themeCover:hover img{transform:scale(1.012)}._V3Dra_themeCover:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4f6ef7);outline-offset:-3px}._V3Dra_themeCoverEmpty{cursor:default;color:var(--dsw-alias-label-tertiary,#8b93a1);flex-direction:column;justify-content:center;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}._V3Dra_themePreviewAction,._V3Dra_themePreviewCount{color:#fff;-webkit-backdrop-filter:blur(8px);background:#14181fc7;border:1px solid #ffffff57;border-radius:4px;align-items:center;height:24px;padding:0 8px;font-size:11px;line-height:16px;display:inline-flex;position:absolute;bottom:8px}._V3Dra_themePreviewAction{gap:4px;right:8px}._V3Dra_themePreviewCount{left:8px}._V3Dra_themeCardBody{flex-direction:column;flex:1;gap:8px;padding:12px;display:flex}._V3Dra_themeCardHead{align-items:flex-start;gap:8px;min-width:0;display:flex}._V3Dra_themeIdentity{flex:1;min-width:0}._V3Dra_themeStatus,._V3Dra_themeStatusMuted{white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:22px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}._V3Dra_themeStatus{background:var(--dsw-alias-state-success-tertiary,#16a34a1a);color:var(--dsw-alias-state-success-primary,#15803d)}._V3Dra_themeStatusMuted{background:var(--dsw-alias-bg-layer-2,#f3f4f6);color:var(--dsw-alias-label-secondary,#6b7280)}._V3Dra_themeDescription{min-height:36px;color:var(--dsw-alias-label-tertiary,#8b93a1);-webkit-line-clamp:3;-webkit-box-orient:vertical;margin:0;font-size:12px;line-height:18px;display:-webkit-box;overflow:hidden}._V3Dra_themeCardFooter{justify-content:space-between;align-items:center;gap:8px;margin-top:auto;padding-top:4px;display:flex}._V3Dra_themeLifecycle{min-width:0;color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:18px;overflow:hidden}._V3Dra_themeActions{flex-wrap:wrap;justify-content:flex-end;align-items:center;gap:8px;margin-left:auto;display:flex}@container (width<=900px){._V3Dra_themeGallery{grid-template-columns:repeat(3,minmax(0,1fr))}}@container (width<=680px){._V3Dra_themeGallery{grid-template-columns:repeat(2,minmax(0,1fr))}}@container (width<=460px){._V3Dra_themeGallery{grid-template-columns:minmax(0,1fr)}}@container (width<=420px){._V3Dra_sub{grid-template-columns:minmax(0,1fr) auto;align-items:start;gap:2px 8px;display:grid}._V3Dra_sub>span:first-child{grid-area:1/1}._V3Dra_sub>._V3Dra_grow{display:none}._V3Dra_submitLink{grid-area:2/1}._V3Dra_exportLogBtn{flex-shrink:0;grid-area:1/2/span 2}._V3Dra_themeToolbar{grid-template-columns:minmax(0,1fr)}._V3Dra_themeCardHead{flex-wrap:wrap}._V3Dra_themeStatus,._V3Dra_themeStatusMuted{order:3}}@container (width<=280px){._V3Dra_themeCardFooter{flex-direction:column;align-items:flex-start}._V3Dra_themeActions{justify-content:flex-start;width:100%;margin-left:0}}@media (max-width:560px){[role=dialog]:has([data-dsh-market-root])>nav{display:none}[role=dialog]:has([data-dsh-market-root])>div{flex:100%;width:100%;min-width:0}}[role=dialog]:has([data-dsh-market-fullscreen=true]){border-radius:0;width:100vw;max-width:none;height:100vh;max-height:none;position:fixed;top:0;bottom:0;left:0;right:0}@media (prefers-reduced-motion:reduce){._V3Dra_themeCard,._V3Dra_themeCover img{transition:none}._V3Dra_themeCard:hover{transform:none}}._V3Dra_card{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;align-self:start;gap:12px;padding:12px 14px;display:flex}._V3Dra_row1{align-items:flex-start;gap:10px;min-width:0;display:flex}._V3Dra_cardAction{flex-shrink:0;align-items:center;display:inline-flex}._V3Dra_installBtn._V3Dra_installBtn{min-width:64px}._V3Dra_av{color:#fff;object-fit:cover;background:var(--dsw-alias-bg-layer-2,#f3f4f6);border-radius:50%;flex-shrink:0;place-items:center;width:16px;height:16px;font-size:9px;font-weight:700;display:grid}._V3Dra_nm{text-overflow:ellipsis;white-space:nowrap;font-size:15px;font-weight:600;line-height:22px;overflow:hidden}._V3Dra_nmLink{color:inherit;text-decoration:none;display:block}._V3Dra_nmLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}._V3Dra_repoMark{color:var(--dsw-alias-label-secondary,#6b7280);vertical-align:-1px;flex-shrink:0;margin-left:5px;display:inline-block}._V3Dra_nmLink:hover ._V3Dra_repoMark{color:var(--dsw-alias-brand-primary,#4f6ef7)}._V3Dra_byline{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}._V3Dra_meta{color:var(--dsw-alias-label-secondary,#9ca3af);margin-top:2px;font-size:11px}._V3Dra_metaInline{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px}._V3Dra_owner{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:44px;font-size:11px;overflow:hidden}._V3Dra_desc{color:var(--dsw-alias-label-tertiary,#8b93a1);margin:0;font-size:12px;line-height:18px}._V3Dra_descClamp{-webkit-line-clamp:5;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}._V3Dra_descToggle{width:20px;height:16px;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;background:0 0;border:none;justify-content:center;align-items:center;margin-top:2px;padding:0;display:flex}._V3Dra_descToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}._V3Dra_foot{flex-wrap:wrap;align-items:center;gap:8px;display:flex}._V3Dra_foot ._V3Dra_metaInline,._V3Dra_foot ._V3Dra_src{white-space:nowrap}._V3Dra_grow{flex:1}._V3Dra_titleRow{align-items:center;gap:10px;display:flex}._V3Dra_version{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px;line-height:20px}._V3Dra_repoLink{color:var(--dsw-alias-label-tertiary,#8b93a1);flex-shrink:0;font-size:12px;line-height:20px;text-decoration:none}._V3Dra_repoLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}._V3Dra_noteRow{flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex}._V3Dra_noteMine{color:var(--dsw-alias-label-primary,#1f2328)}._V3Dra_noteToggle{font:inherit;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;white-space:nowrap;background:0 0;border:none;flex-shrink:0;padding:0;font-size:11px;line-height:16px}._V3Dra_noteToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}._V3Dra_noteAction{color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:4px;align-items:center;padding:0 5px;font-weight:600;text-decoration:none;display:inline-flex}._V3Dra_noteAction:hover{color:var(--dsw-alias-label-primary,#1f2328);border-color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:none}._V3Dra_noteEdit{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}._V3Dra_noteInput{flex:1;min-width:160px}._V3Dra_descTight{min-height:0}._V3Dra_src{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px;text-decoration:none}._V3Dra_src:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}._V3Dra_dot{vertical-align:2px;margin-left:5px}._V3Dra_act{flex-wrap:wrap;align-items:center;gap:6px;margin-top:6px;font-size:11px;display:flex}._V3Dra_actLive{color:var(--dsw-alias-state-success-primary,#16a34a);align-items:center;gap:4px;font-weight:600;display:inline-flex}._V3Dra_actWarn{color:var(--dsw-alias-state-warn-primary,#b45309);align-items:center;gap:4px;font-weight:600;display:inline-flex}._V3Dra_actBroken{color:var(--dsw-alias-state-error-primary,#dc2626);align-items:center;gap:4px;font-weight:600;display:inline-flex}._V3Dra_actWhy{color:var(--dsw-alias-label-secondary,#6b7280);margin-top:2px}._V3Dra_loading{color:var(--dsw-alias-label-secondary,#9ca3af);flex-direction:column;align-items:center;gap:12px;padding:48px;font-size:13px;display:flex}._V3Dra_spin{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;animation:.8s linear infinite _V3Dra_sp;display:inline-flex}._V3Dra_logoMark{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;display:inline-flex}._V3Dra_logoPlug{transform-box:fill-box;transform-origin:50%;animation:1.5s cubic-bezier(.4,0,.2,1) infinite _V3Dra_dshmPlug}@keyframes _V3Dra_dshmPlug{0%,12%{transform:rotate(9deg)}45%,62%{transform:translate(-1.28px,1.27px)rotate(0)}95%,to{transform:rotate(9deg)}}@media (prefers-reduced-motion:reduce){._V3Dra_logoPlug,._V3Dra_spin{animation:1.5s ease-in-out infinite _V3Dra_dshmPlugFade}}@keyframes _V3Dra_dshmPlugFade{0%,to{opacity:1}50%{opacity:.35}}@keyframes _V3Dra_sp{to{transform:rotate(360deg)}}._V3Dra_progress{background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:8px;flex-wrap:wrap;align-items:center;gap:9px;margin:0;padding:8px 12px;font-size:12px;display:flex}._V3Dra_bar{background:var(--dsw-alias-border-l1,#e5e7eb);border-radius:99px;width:100%;height:4px;overflow:hidden}._V3Dra_barFill{background:var(--dsw-alias-brand-primary,#4f6ef7);border-radius:99px;height:100%;transition:width .6s}._V3Dra_barWave{width:30%;animation:1.2s ease-in-out infinite _V3Dra_dshmSlide}@keyframes _V3Dra_dshmSlide{0%{margin-left:-30%}to{margin-left:100%}}._V3Dra_irow ._V3Dra_progress{margin-top:8px}._V3Dra_progress code{text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}._V3Dra_empty{color:var(--dsw-alias-label-secondary,#9ca3af);text-align:center;padding:32px;font-size:13px}._V3Dra_err{color:var(--dsw-alias-state-error-primary,#dc2626);white-space:pre-wrap;word-break:break-all;margin:8px 0;font-size:12px}._V3Dra_cardBlocked{border-color:var(--dsw-alias-state-error-primary,#dc2626)}._V3Dra_conflictHead{align-items:flex-start;gap:8px;display:flex}._V3Dra_conflictIcon{color:var(--dsw-alias-state-error-primary,#dc2626);flex-shrink:0;margin-top:1px}._V3Dra_conflictTitle{color:var(--dsw-alias-state-error-primary,#dc2626);font-size:13px;font-weight:600;line-height:18px}._V3Dra_conflictBody{margin:0;font-size:12px;line-height:19px}._V3Dra_roster{background:var(--dsw-alias-border-l2,#e5e7eb);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-direction:column;gap:1px;display:flex;overflow:hidden}._V3Dra_rosterRow{background:var(--dsw-alias-bg-layer-1,#fff);align-items:center;gap:8px;padding:7px 10px;display:flex}._V3Dra_rosterMain{flex-direction:column;min-width:0;display:flex}._V3Dra_rosterName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;font-weight:600;overflow:hidden}._V3Dra_rosterAuthor{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;overflow:hidden}._V3Dra_rosterTag{border-radius:4px;flex-shrink:0;margin-left:auto;padding:1px 6px;font-size:10.5px;font-weight:600}._V3Dra_rosterTagKeep{color:var(--dsw-alias-state-success-primary,#16a34a);background:#16a34a1f}._V3Dra_rosterTagDrop{color:var(--dsw-alias-state-error-primary,#dc2626);background:#dc26261f}._V3Dra_rosterRowOut ._V3Dra_rosterName{text-decoration:line-through}._V3Dra_rosterRowOut{opacity:.62}._V3Dra_rosterSplit{background:var(--dsw-alias-border-l2,#e5e7eb);height:1px}._V3Dra_reassure{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:5px;margin:0;font-size:11.5px;line-height:17px;display:flex}._V3Dra_reassureOk{color:var(--dsw-alias-state-success-primary,#16a34a);flex-shrink:0}._V3Dra_conflictWhy{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;margin-top:2px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:17px}._V3Dra_conflictWhyText{margin-top:5px;font-family:-apple-system,BlinkMacSystemFont,PingFang SC,sans-serif}._V3Dra_choices{flex-direction:column;gap:7px;display:flex}._V3Dra_choice{text-align:left;font:inherit;cursor:pointer;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:9px;align-items:flex-start;gap:9px;padding:9px 11px;display:flex}._V3Dra_choice:has(input:disabled){cursor:default;opacity:.6}._V3Dra_choiceOn{border-color:var(--dsw-alias-brand-primary,#4f6ef7);background:var(--dsw-alias-bg-layer-2,#f5f7ff)}._V3Dra_choiceRadio{width:13px;height:13px;accent-color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;margin:2px 0 0}._V3Dra_choiceMain{flex-direction:column;gap:3px;min-width:0;display:flex}._V3Dra_choiceTitle{font-size:12px;font-weight:600;line-height:17px}._V3Dra_choiceNote{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px;line-height:16px}._V3Dra_choiceSafe{color:var(--dsw-alias-state-success-primary,#16a34a)}._V3Dra_stateTag{white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-height:20px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:5px;flex-shrink:0;align-items:center;gap:5px;padding:1px 7px;font-size:11px;line-height:16px;display:inline-flex}._V3Dra_stateTag[data-on=true]{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}._V3Dra_stateDot{background:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:999px;flex:none;width:6px;height:6px}._V3Dra_stateDot[data-on=true]{background:var(--dsw-alias-state-success-primary,#16a34a)}._V3Dra_metaTag{text-overflow:ellipsis;white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:0;max-width:100%;min-height:20px;color:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:5px;flex-shrink:1;padding:1px 7px;font-size:11px;line-height:18px;display:inline-block;overflow:hidden}._V3Dra_metaTagOk{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}._V3Dra_nameLink{color:inherit;text-decoration:none}._V3Dra_irowName{text-overflow:clip;flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex;overflow:visible}._V3Dra_irowNameText{overflow-wrap:anywhere;white-space:normal;min-width:0}._V3Dra_irowName>._V3Dra_owner{flex:none}._V3Dra_nameLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}._V3Dra_opWrap{flex-shrink:0;display:inline-flex;position:relative}._V3Dra_opEntry{font:inherit;cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:7px;align-items:center;gap:6px;padding:4px 10px;font-size:12px;display:inline-flex;position:relative}._V3Dra_opEntryQuiet{color:var(--dsw-alias-label-secondary,#6b7280);background:0 0;border-color:#0000}._V3Dra_opEntryAlert{border-color:var(--dsw-alias-state-error-primary,#dc2626);color:var(--dsw-alias-state-error-primary,#dc2626)}._V3Dra_opDot{background:var(--dsw-alias-state-error-primary,#dc2626);border-radius:99px;width:8px;height:8px;position:absolute;top:-3px;right:-3px}._V3Dra_opPanel{z-index:40;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:12px;width:460px;max-width:86vw;max-height:70vh;position:absolute;top:calc(100% + 6px);right:0;overflow-y:auto;box-shadow:0 20px 52px #00000047}._V3Dra_opHead{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:center;gap:8px;padding:9px 14px;display:flex}._V3Dra_opPanelTitle{font-size:12.5px;font-weight:600}._V3Dra_opCloseBtn._V3Dra_opCloseBtn{min-width:0;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}._V3Dra_opAggregate{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f7f8fa);padding:9px 14px}._V3Dra_opAggregateTop{font-variant-numeric:tabular-nums;font-size:12px;font-weight:600}._V3Dra_opAggregateHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:10.5px}._V3Dra_opRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-start;gap:9px;padding:9px 14px;display:flex}._V3Dra_opRow:last-child{border-bottom:none}._V3Dra_opRowAlert{background:#dc26260f}._V3Dra_opIcon{flex-shrink:0;place-items:center;width:14px;margin-top:1px;display:grid}._V3Dra_opQueuedIcon{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px}._V3Dra_opMain{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}._V3Dra_opTop{align-items:baseline;gap:6px;min-width:0;display:flex}._V3Dra_opVerb{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:12px}._V3Dra_opName{text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:600;overflow:hidden}._V3Dra_opStatus{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;font-size:10.5px;line-height:16px}._V3Dra_opStatusBad{color:var(--dsw-alias-state-error-primary,#dc2626)}._V3Dra_opActions{flex-shrink:0;align-items:center;gap:6px;margin-top:1px;display:flex}._V3Dra_opDecision{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;margin-top:8px;padding-top:8px;display:flex}._V3Dra_opDecisionFoot{align-items:center;gap:8px;display:flex}._V3Dra_conflictDetailsToggle{font:inherit;cursor:pointer;color:var(--dsw-alias-label-tertiary,#8b93a1);background:0 0;border:none;align-items:center;gap:4px;padding:2px 0;font-size:11px;display:inline-flex}._V3Dra_conflictDetailsToggle:hover{color:var(--dsw-alias-label-secondary,#6b7280)}._V3Dra_opEmpty{text-align:center;color:var(--dsw-alias-label-secondary,#6b7280);padding:30px 14px;font-size:12px}._V3Dra_opEmptyHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:11px}._V3Dra_cardBlockedMark{font:inherit;cursor:pointer;color:var(--dsw-alias-state-error-primary,#dc2626);border:1px solid var(--dsw-alias-state-error-primary,#dc2626);background:#dc262614;border-radius:7px;align-items:center;gap:5px;padding:4px 9px;font-size:11px;display:inline-flex}._V3Dra_dangerBtn._V3Dra_dangerBtn{color:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626)}._V3Dra_dangerBtn._V3Dra_dangerBtn:hover:not(:disabled){background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}._V3Dra_dangerArmed._V3Dra_dangerArmed{background:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}._V3Dra_retryBtn{margin-top:4px}._V3Dra_irow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:10px;flex-direction:column;gap:10px;min-width:0;padding:12px 14px;display:flex}._V3Dra_irowActions{flex-wrap:wrap;justify-content:flex-start;align-items:center;gap:8px;min-width:0;display:flex}._V3Dra_irowTrailing{flex-wrap:nowrap;align-items:center;gap:8px;min-width:0;display:inline-flex}._V3Dra_irowMissing{filter:grayscale();opacity:.5}._V3Dra_irow>._V3Dra_src,._V3Dra_irow>._V3Dra_owner,._V3Dra_irow button{white-space:nowrap;flex-shrink:0}._V3Dra_tabSearchRow{padding:0 4px 6px;display:flex}._V3Dra_tabSearch{width:100%}._V3Dra_spec{color:var(--dsw-alias-label-secondary,#9ca3af);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:11px}._V3Dra_specTag{white-space:nowrap;border-radius:4px;flex-shrink:0;align-items:center;height:16px;padding:0 5px;font-size:10px;font-weight:600;display:inline-flex}._V3Dra_specTagGit{color:#0b7285;background:#12a3c41f}._V3Dra_specTagFile{color:#b07d1b;background:#f0b42924}._V3Dra_backupCheckList ._V3Dra_grow{white-space:nowrap;text-overflow:ellipsis;flex:70%;min-width:0;overflow:hidden}._V3Dra_backupCheckList ._V3Dra_spec{text-align:right;white-space:nowrap;text-overflow:ellipsis;flex:0 30%;max-width:30%;overflow:hidden}._V3Dra_staleAction{margin-top:8px}._V3Dra_pct{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:11px;font-weight:600}._V3Dra_pager{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;margin:16px 0 4px;display:flex}._V3Dra_pagerPages{flex-wrap:wrap;flex:1;justify-content:center;align-items:center;gap:6px;min-width:0;display:flex}._V3Dra_pageEllipsis{color:var(--dsw-alias-label-secondary,#9ca3af);padding:0 2px;font-size:12px}._V3Dra_pageInfo{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;font-size:12px}._V3Dra_depBadge{border:1px solid var(--dsw-alias-state-warn-primary,#b45309);color:var(--dsw-alias-state-warn-primary,#b45309);white-space:nowrap;border-radius:4px;flex-shrink:0;margin-left:6px;padding:1px 6px;font-size:11px;font-weight:600;line-height:16px}._V3Dra_deprecate{color:var(--dsw-alias-state-warn-primary,#b45309);background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;margin:0;padding:8px 10px;font-size:12px;line-height:18px}._V3Dra_deprecate a{color:var(--dsw-alias-state-warn-primary,#b45309);text-decoration:underline}._V3Dra_deprecate ._V3Dra_src{margin-left:8px}._V3Dra_depLine{flex-wrap:wrap;align-items:center;gap:8px;display:flex}._V3Dra_switch{border:1px solid var(--dsw-alias-border-l2,#d9dde3);background:var(--dsw-alias-bg-layer-2,#e5e7eb);cursor:pointer;border-radius:99px;flex-shrink:0;width:38px;height:22px;padding:0;transition:background .15s,border-color .15s;position:relative}._V3Dra_switchOn{background:var(--dsw-alias-state-success-primary,#16a34a);border-color:var(--dsw-alias-state-success-primary,#16a34a)}._V3Dra_switchMixed{background:var(--dsw-alias-state-warn-primary,#b45309);border-color:var(--dsw-alias-state-warn-primary,#b45309)}._V3Dra_switchKnob{background:#fff;border-radius:99px;width:16px;height:16px;transition:left .15s;position:absolute;top:2px;left:2px;box-shadow:0 1px 2px #00000040}._V3Dra_switchOn ._V3Dra_switchKnob,._V3Dra_switchMixed ._V3Dra_switchKnob{left:18px}._V3Dra_switch:disabled{opacity:.5;cursor:default}._V3Dra_viewBar{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;align-items:center;gap:2px;width:fit-content;margin-bottom:12px;padding:2px;display:flex}._V3Dra_viewBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-radius:6px;padding:4px 10px;font-size:12px;line-height:18px}._V3Dra_viewBtn:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}._V3Dra_viewOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}._V3Dra_groupRow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;margin-bottom:10px;padding:12px 14px}._V3Dra_groupHead{align-items:center;gap:10px;min-width:0;display:flex}._V3Dra_groupName{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}._V3Dra_groupActions{flex-shrink:0;align-items:center;gap:6px;display:flex}._V3Dra_groupMembers{flex-direction:column;gap:6px;margin-top:10px;display:flex}._V3Dra_groupMember{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:12px;line-height:18px;display:flex}._V3Dra_groupMember ._V3Dra_nm{flex:1;min-width:0;font-size:12px}._V3Dra_groupAddPanel{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:6px;margin-top:10px;padding-top:10px;display:flex}._V3Dra_groupCreate{align-items:center;gap:8px;margin-bottom:10px;display:flex}._V3Dra_inlineInput{flex:1;min-width:120px}._V3Dra_assignRow{flex-wrap:wrap;align-items:center;gap:8px;display:flex}._V3Dra_assignSelect{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#1f2328);font:inherit;border-radius:6px;padding:3px 6px;font-size:12px;line-height:18px}._V3Dra_groupHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px}._V3Dra_sectAction{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:8px;margin:14px 2px 8px;font-size:12px;font-weight:600;display:flex}._V3Dra_backupGrid{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:12px;display:grid}._V3Dra_backupCard{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:10px;padding:16px;display:flex}._V3Dra_backupCard h3{margin:0;font-size:14px}._V3Dra_backupCard p{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}._V3Dra_backupActions{flex-wrap:wrap;gap:8px;display:flex;position:relative}._V3Dra_hiddenFile{opacity:0;pointer-events:none;width:1px;height:1px;position:absolute}._V3Dra_backupInput{box-sizing:border-box;width:100%}._V3Dra_backupCheck{cursor:pointer;align-items:center;gap:6px;font-size:12px;display:flex}._V3Dra_backupWarn{margin:0;font-size:12px;line-height:18px;color:var(--dsw-alias-state-warn-primary,#b45309)!important}._V3Dra_backupMessage{color:var(--dsw-alias-label-secondary,#6b7280);grid-column:1/-1;font-size:12px}._V3Dra_backupCheckList{flex-direction:column;gap:6px;max-height:260px;margin:10px 0 4px;padding-right:4px;display:flex;overflow-y:auto}._V3Dra_backupCheckList ._V3Dra_backupCheck{justify-content:space-between;gap:8px}._V3Dra_diagPage{flex-direction:column;gap:12px;height:100%;min-height:0;display:flex;overflow-y:auto}._V3Dra_diagSummary{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-wrap:wrap;align-items:center;gap:12px;padding:10px 14px;font-size:12px;display:flex}._V3Dra_diagSummaryItem{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;align-items:center;gap:6px;display:inline-flex}._V3Dra_diagSummaryMeta{color:var(--dsw-alias-label-tertiary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;max-width:320px;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}._V3Dra_diagSection{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:8px;padding:12px 14px;display:flex}._V3Dra_diagSection h3{color:var(--dsw-alias-label-primary,#1f2328);margin:0;font-size:13px;font-weight:600}._V3Dra_diagCount{color:var(--dsw-alias-label-tertiary,#9ca3af);font-size:11px;font-weight:400}._V3Dra_diagEmpty{color:var(--dsw-alias-label-secondary,#9ca3af);padding:8px 0;font-size:12px}._V3Dra_diagBundle{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);flex-direction:column;gap:6px;padding-top:8px;display:flex}._V3Dra_diagBundle:first-of-type{border-top:none;padding-top:0}._V3Dra_diagRow{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;font-size:12px;line-height:18px;display:flex}._V3Dra_diagMeta{align-items:baseline;gap:8px;min-width:0;font-size:12px;display:flex}._V3Dra_diagKey{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;min-width:64px;font-size:11px}._V3Dra_diagVal{color:var(--dsw-alias-label-primary,#1f2328);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:12px;font-weight:500}._V3Dra_diagIndex{background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:18px;height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;justify-content:center;align-items:center;font-size:11px;font-weight:600;display:inline-flex}._V3Dra_diagArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}._V3Dra_diagBadgeOfficial{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}._V3Dra_diagBadgeCommunity{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}._V3Dra_diagBadgeShadow{background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}._V3Dra_diagBadgeWarn{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}._V3Dra_diagBadgeInfo{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}._V3Dra_diagList{flex-direction:column;gap:6px;display:flex}._V3Dra_sectionOverview{color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;max-width:100%;padding:2px 0 6px;font-size:12px;line-height:18px;overflow:hidden}._V3Dra_diagAlert{color:var(--dsw-alias-state-warn-primary,#b45309)}._V3Dra_ovRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}._V3Dra_ovArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}._V3Dra_ovByTag{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;text-overflow:ellipsis;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;max-width:260px;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex;overflow:hidden}._V3Dra_ovFrom{color:var(--dsw-alias-label-secondary,#6b7280);text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;overflow:hidden}._V3Dra_orphRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}._V3Dra_orphBadge{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}._V3Dra_dragHandle{width:20px;height:20px;color:var(--dsw-alias-label-tertiary,#9ca3af);cursor:grab;-webkit-user-select:none;user-select:none;flex-shrink:0;justify-content:center;align-items:center;font-size:12px;line-height:20px;display:inline-flex}._V3Dra_dragOver{outline:2px dashed var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:2px;background:var(--dsw-alias-bg-layer-2,#f0f2f8);border-radius:8px}._V3Dra_dragging{opacity:.45;background:var(--dsw-alias-bg-layer-2,#f3f4f6)}._V3Dra_collapseHead{font:inherit;color:var(--dsw-alias-label-primary,#1f2328);cursor:pointer;text-align:left;background:0 0;border:none;align-items:center;gap:8px;width:100%;padding:0;font-size:13px;font-weight:600;display:flex}._V3Dra_collapseIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;display:inline-flex}._V3Dra_collapseTitle{flex:1;min-width:0}._V3Dra_collapseBody{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);overflow-wrap:anywhere;flex-direction:column;gap:10px;min-width:0;margin-top:8px;padding-top:10px;display:flex}._V3Dra_orderPanel{flex-direction:column;gap:10px;min-width:0;display:flex}._V3Dra_panelNote{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}._V3Dra_panelActions{flex-wrap:wrap;align-items:center;gap:8px;display:flex}._V3Dra_presetList{flex-direction:column;gap:6px;min-width:0;display:flex}._V3Dra_presetRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:6px;min-width:0;max-width:100%;padding:8px 10px;font-size:12px;line-height:18px;display:flex}._V3Dra_presetName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:13px;font-weight:600;overflow:hidden}._V3Dra_snapList{flex-direction:column;gap:6px;min-width:0;display:flex}._V3Dra_snapRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:8px;padding:10px 12px;font-size:12px;line-height:18px;display:flex}._V3Dra_snapMeta{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;display:flex}._V3Dra_snapConfirmText{color:var(--dsw-alias-state-warn-primary,#b45309);margin:0;font-size:12px;line-height:18px}._V3Dra_confirmRow{flex-wrap:wrap;align-items:center;gap:6px;display:inline-flex}._V3Dra_fixFallback{flex-direction:column;gap:6px;margin:8px 0;display:flex}._V3Dra_fixFallbackText{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);resize:vertical;white-space:pre-wrap;word-break:break-all;border-radius:6px;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:16px}._V3Dra_setCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-3,#fff);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}._V3Dra_setCard:hover{border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}._V3Dra_setCardOpen{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}._V3Dra_setHeader{-webkit-appearance:none;appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}._V3Dra_setHeader:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:-2px}._V3Dra_setHeadText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}._V3Dra_setName{color:var(--dsw-alias-label-primary,#1f2328);font-size:15px;font-weight:600;line-height:1.4}._V3Dra_setDesc{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:13px;line-height:1.5}._V3Dra_setChevron{color:var(--dsw-alias-label-tertiary,#8b93a1);flex:none;transition:transform .16s;display:inline-flex}._V3Dra_setChevronOpen{transform:rotate(180deg)}._V3Dra_setBody{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);margin:0 16px;padding-bottom:8px}._V3Dra_setRow{align-items:center;gap:12px;padding:12px 0;display:flex}._V3Dra_setRow+._V3Dra_setRow{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb)}._V3Dra_setLabelBox{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}._V3Dra_setLabel{font-size:13px;line-height:20px}._V3Dra_setHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px;line-height:18px}._V3Dra_setConfirm{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;padding:12px 0 4px;display:flex}._V3Dra_setCheck{cursor:pointer;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}._V3Dra_setActions{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}._V3Dra_setDanger{color:var(--dsw-alias-state-error-primary,#dc2626)}._V3Dra_setSeg{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-shrink:0;gap:2px;padding:2px;display:inline-flex}._V3Dra_setSegBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;background:0 0;border:none;border-radius:6px;padding:3px 10px;font-size:12px;line-height:18px}._V3Dra_setSegBtn:disabled{cursor:default;opacity:.5}._V3Dra_setSegOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}._V3Dra_setBetaTag{background:var(--dsw-alias-bg-module-platform,#eef0f4);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;margin-left:6px;padding:0 6px;font-size:11px;font-weight:600;line-height:17px}._V3Dra_commentsLink{cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-secondary,#9ca3af);background:0 0;border:0;padding:0;font-size:11px;line-height:16px}._V3Dra_commentsLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}._V3Dra_commentsNote{color:var(--dsw-alias-label-secondary,#9ca3af);margin:0 0 8px;font-size:11px;line-height:16px}._V3Dra_commentsStatus{color:var(--dsw-alias-label-secondary,#9ca3af);margin:0;font-size:12px}._V3Dra_commentsStatus:empty{display:none}._V3Dra_commentsError{color:var(--dsw-alias-label-primary,#1f2328);margin:0 0 8px;font-size:12px}._V3Dra_commentsFail{flex-direction:column;align-items:flex-start;gap:8px;padding:12px 0;display:flex}._V3Dra_commentsMount{width:100%;min-height:240px;max-height:56vh;overflow:auto}._V3Dra_commentsMount iframe{width:100%}._V3Dra_notesLink{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;text-align:left;background:0 0;border:none;margin:2px 0 0;padding:0;font-size:12px;line-height:18px;display:block}._V3Dra_notesLink:hover{color:var(--dsw-alias-label-primary,#1f2328)}._V3Dra_notesBody{flex-direction:column;gap:8px;min-width:0;display:flex}._V3Dra_notesRange{align-items:center;gap:8px;margin-bottom:4px;font-size:12px;line-height:18px;display:flex}._V3Dra_notesArrow{color:var(--dsw-alias-label-tertiary,#8b93a1)}._V3Dra_notesMeta{letter-spacing:.02em;text-transform:uppercase;color:var(--dsw-alias-label-secondary,#6b7280);flex-wrap:wrap;align-items:baseline;gap:6px;margin-top:12px;font-size:12px;line-height:18px;display:flex}._V3Dra_notesPre{white-space:pre-wrap;word-break:break-word;background:var(--dsw-alias-bg-layer-2,#eef0f4);border-radius:8px;max-height:40vh;margin:0;padding:10px 12px;font-size:13px;line-height:20px;overflow:auto}._V3Dra_notesList{flex-direction:column;gap:6px;margin:0;padding-left:18px;font-size:13px;line-height:20px;display:flex}._V3Dra_notesRendered{flex-direction:column;gap:6px;min-width:0;display:flex}._V3Dra_notesH{margin-top:6px;font-size:13px;font-weight:650;line-height:20px}._V3Dra_notesP{font-size:13px;line-height:20px}._V3Dra_notesCode{font-family:var(--dsw-alias-font-mono,ui-monospace,monospace);background:var(--dsw-alias-bg-layer-2,#eef0f4);border-radius:5px;padding:1px 5px;font-size:12px}._V3Dra_notesList{flex-direction:column;margin:0;padding:0;list-style:none;display:flex}._V3Dra_notesRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:baseline;gap:12px;padding:6px 0;display:flex}._V3Dra_notesRow:last-child{border-bottom:none}._V3Dra_notesDate{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px}._V3Dra_notesMsg{word-break:break-word;word-break:break-word;-webkit-line-clamp:3;-webkit-box-orient:vertical;min-width:0;font-size:13px;line-height:20px;display:-webkit-box;overflow:hidden}._V3Dra_notesSha{color:var(--dsw-alias-label-secondary,#6b7280);font-variant-numeric:tabular-nums;flex-shrink:0;margin-left:auto;font-size:12px;text-decoration:none}._V3Dra_notesSha:hover{color:var(--dsw-alias-label-primary,#1f2328);text-decoration:underline}._V3Dra_notesVer{color:inherit;font-weight:600;text-decoration:none}._V3Dra_notesVer:hover{text-decoration:underline}";
		...
		var Market_module_css_default = {
			"act": "_V3Dra_act",
			"actBroken": "_V3Dra_actBroken",
			"actLive": "_V3Dra_actLive",
			"actWarn": "_V3Dra_actWarn",
			"actWhy": "_V3Dra_actWhy",
			"assignRow": "_V3Dra_assignRow",
			"assignSelect": "_V3Dra_assignSelect",
			"av": "_V3Dra_av",
			"backupActions": "_V3Dra_backupActions",
			"backupCard": "_V3Dra_backupCard",
			"backupCheck": "_V3Dra_backupCheck",
			"backupCheckList": "_V3Dra_backupCheckList",
			"backupGrid": "_V3Dra_backupGrid",
			"backupInput": "_V3Dra_backupInput",
			"backupMessage": "_V3Dra_backupMessage",
			"backupWarn": "_V3Dra_backupWarn",
			"banner": "_V3Dra_banner",
			"bannerHint": "_V3Dra_bannerHint",
			"bannerIcon": "_V3Dra_bannerIcon",
			"bar": "_V3Dra_bar",
			"barFill": "_V3Dra_barFill",
			"barWave": "_V3Dra_barWave",
			"body": "_V3Dra_body",
			"byline": "_V3Dra_byline",
			"card": "_V3Dra_card",
			"cardAction": "_V3Dra_cardAction",
			"cardBlocked": "_V3Dra_cardBlocked",
			"cardBlockedMark": "_V3Dra_cardBlockedMark",
			"cardShot": "_V3Dra_cardShot",
			"cardShots": "_V3Dra_cardShots",
			"cats": "_V3Dra_cats",
			"catsCollapsed": "_V3Dra_catsCollapsed",
			"catsRow": "_V3Dra_catsRow",
			"catsToggle": "_V3Dra_catsToggle",
			"catsWrap": "_V3Dra_catsWrap",
			"choice": "_V3Dra_choice",
			"choiceMain": "_V3Dra_choiceMain",
			"choiceNote": "_V3Dra_choiceNote",
			"choiceOn": "_V3Dra_choiceOn",
			"choiceRadio": "_V3Dra_choiceRadio",
			"choices": "_V3Dra_choices",
			"choiceSafe": "_V3Dra_choiceSafe",
			"choiceTitle": "_V3Dra_choiceTitle",
			"cmd": "_V3Dra_cmd",
			"collapseBody": "_V3Dra_collapseBody",
			"collapseHead": "_V3Dra_collapseHead",
			"collapseIcon": "_V3Dra_collapseIcon",
			"collapseTitle": "_V3Dra_collapseTitle",
			"commentsError": "_V3Dra_commentsError",
			"commentsFail": "_V3Dra_commentsFail",
			"commentsLink": "_V3Dra_commentsLink",
			"commentsMount": "_V3Dra_commentsMount",
			"commentsNote": "_V3Dra_commentsNote",
			"commentsStatus": "_V3Dra_commentsStatus",
			"confirmRow": "_V3Dra_confirmRow",
			"conflictBody": "_V3Dra_conflictBody",
			"conflictDetailsToggle": "_V3Dra_conflictDetailsToggle",
			"conflictHead": "_V3Dra_conflictHead",
			"conflictIcon": "_V3Dra_conflictIcon",
			"conflictTitle": "_V3Dra_conflictTitle",
			"conflictWhy": "_V3Dra_conflictWhy",
			"conflictWhyText": "_V3Dra_conflictWhyText",
			"dangerArmed": "_V3Dra_dangerArmed",
			"dangerBtn": "_V3Dra_dangerBtn",
			"depBadge": "_V3Dra_depBadge",
			"depLine": "_V3Dra_depLine",
			"deprecate": "_V3Dra_deprecate",
			"desc": "_V3Dra_desc",
			"descClamp": "_V3Dra_descClamp",
			"descTight": "_V3Dra_descTight",
			"descToggle": "_V3Dra_descToggle",
			"diagAlert": "_V3Dra_diagAlert",
			"diagArrow": "_V3Dra_diagArrow",
			"diagBadgeCommunity": "_V3Dra_diagBadgeCommunity",
			"diagBadgeInfo": "_V3Dra_diagBadgeInfo",
			"diagBadgeOfficial": "_V3Dra_diagBadgeOfficial",
			"diagBadgeShadow": "_V3Dra_diagBadgeShadow",
			"diagBadgeWarn": "_V3Dra_diagBadgeWarn",
			"diagBundle": "_V3Dra_diagBundle",
			"diagCount": "_V3Dra_diagCount",
			"diagEmpty": "_V3Dra_diagEmpty",
			"diagIndex": "_V3Dra_diagIndex",
			"diagKey": "_V3Dra_diagKey",
			"diagList": "_V3Dra_diagList",
			"diagMeta": "_V3Dra_diagMeta",
			"diagPage": "_V3Dra_diagPage",
			"diagRow": "_V3Dra_diagRow",
			"diagSection": "_V3Dra_diagSection",
			"diagSummary": "_V3Dra_diagSummary",
			"diagSummaryItem": "_V3Dra_diagSummaryItem",
			"diagSummaryMeta": "_V3Dra_diagSummaryMeta",
			"diagVal": "_V3Dra_diagVal",
			"dot": "_V3Dra_dot",
			"dragging": "_V3Dra_dragging",
			"dragHandle": "_V3Dra_dragHandle",
			"dragOver": "_V3Dra_dragOver",
			"dshmPlug": "_V3Dra_dshmPlug",
			"dshmPlugFade": "_V3Dra_dshmPlugFade",
			"dshmSlide": "_V3Dra_dshmSlide",
			"empty": "_V3Dra_empty",
			"err": "_V3Dra_err",
			"exportLogBtn": "_V3Dra_exportLogBtn",
			"fixFallback": "_V3Dra_fixFallback",
			"fixFallbackText": "_V3Dra_fixFallbackText",
			"foot": "_V3Dra_foot",
			"grid": "_V3Dra_grid",
			"groupActions": "_V3Dra_groupActions",
			"groupAddPanel": "_V3Dra_groupAddPanel",
			"groupCreate": "_V3Dra_groupCreate",
			"groupHead": "_V3Dra_groupHead",
			"groupHint": "_V3Dra_groupHint",
			"groupMember": "_V3Dra_groupMember",
			"groupMembers": "_V3Dra_groupMembers",
			"groupName": "_V3Dra_groupName",
			"groupRow": "_V3Dra_groupRow",
			"grow": "_V3Dra_grow",
			"head": "_V3Dra_head",
			"hiddenFile": "_V3Dra_hiddenFile",
			"inlineInput": "_V3Dra_inlineInput",
			"installBtn": "_V3Dra_installBtn",
			"irow": "_V3Dra_irow",
			"irowActions": "_V3Dra_irowActions",
			"irowMissing": "_V3Dra_irowMissing",
			"irowName": "_V3Dra_irowName",
			"irowNameText": "_V3Dra_irowNameText",
			"irowTrailing": "_V3Dra_irowTrailing",
			"lightbox": "_V3Dra_lightbox",
			"lightboxClose": "_V3Dra_lightboxClose",
			"lightboxDot": "_V3Dra_lightboxDot",
			"lightboxDotOn": "_V3Dra_lightboxDotOn",
			"lightboxDots": "_V3Dra_lightboxDots",
			"lightboxImg": "_V3Dra_lightboxImg",
			"lightboxNav": "_V3Dra_lightboxNav",
			"lightboxNext": "_V3Dra_lightboxNext",
			"lightboxPrev": "_V3Dra_lightboxPrev",
			"loading": "_V3Dra_loading",
			"logoMark": "_V3Dra_logoMark",
			"logoPlug": "_V3Dra_logoPlug",
			"masonry": "_V3Dra_masonry",
			"masonryCol": "_V3Dra_masonryCol",
			"meta": "_V3Dra_meta",
			"metaInline": "_V3Dra_metaInline",
			"metaTag": "_V3Dra_metaTag",
			"metaTagOk": "_V3Dra_metaTagOk",
			"modalNote": "_V3Dra_modalNote",
			"nameLink": "_V3Dra_nameLink",
			"nm": "_V3Dra_nm",
			"nmLink": "_V3Dra_nmLink",
			"noteAction": "_V3Dra_noteAction",
			"noteEdit": "_V3Dra_noteEdit",
			"noteInput": "_V3Dra_noteInput",
			"noteMine": "_V3Dra_noteMine",
			"noteRow": "_V3Dra_noteRow",
			"notesArrow": "_V3Dra_notesArrow",
			"notesBody": "_V3Dra_notesBody",
			"notesCode": "_V3Dra_notesCode",
			"notesDate": "_V3Dra_notesDate",
			"notesH": "_V3Dra_notesH",
			"notesLink": "_V3Dra_notesLink",
			"notesList": "_V3Dra_notesList",
			"notesMeta": "_V3Dra_notesMeta",
			"notesMsg": "_V3Dra_notesMsg",
			"notesP": "_V3Dra_notesP",
			"notesPre": "_V3Dra_notesPre",
			"notesRange": "_V3Dra_notesRange",
			"notesRendered": "_V3Dra_notesRendered",
			"notesRow": "_V3Dra_notesRow",
			"notesSha": "_V3Dra_notesSha",
			"notesVer": "_V3Dra_notesVer",
			"noteToggle": "_V3Dra_noteToggle",
			"okState": "_V3Dra_okState",
			"on": "_V3Dra_on",
			"opActions": "_V3Dra_opActions",
			"opAggregate": "_V3Dra_opAggregate",
			"opAggregateHint": "_V3Dra_opAggregateHint",
			"opAggregateTop": "_V3Dra_opAggregateTop",
			"opCloseBtn": "_V3Dra_opCloseBtn",
			"opDecision": "_V3Dra_opDecision",
			"opDecisionFoot": "_V3Dra_opDecisionFoot",
			"opDot": "_V3Dra_opDot",
			"opEmpty": "_V3Dra_opEmpty",
			"opEmptyHint": "_V3Dra_opEmptyHint",
			"opEntry": "_V3Dra_opEntry",
			"opEntryAlert": "_V3Dra_opEntryAlert",
			"opEntryQuiet": "_V3Dra_opEntryQuiet",
			"opHead": "_V3Dra_opHead",
			"opIcon": "_V3Dra_opIcon",
			"opMain": "_V3Dra_opMain",
			"opName": "_V3Dra_opName",
			"opPanel": "_V3Dra_opPanel",
			"opPanelTitle": "_V3Dra_opPanelTitle",
			"opQueuedIcon": "_V3Dra_opQueuedIcon",
			"opRow": "_V3Dra_opRow",
			"opRowAlert": "_V3Dra_opRowAlert",
			"opStatus": "_V3Dra_opStatus",
			"opStatusBad": "_V3Dra_opStatusBad",
			"opTop": "_V3Dra_opTop",
			"opVerb": "_V3Dra_opVerb",
			"opWrap": "_V3Dra_opWrap",
			"orderPanel": "_V3Dra_orderPanel",
			"orphBadge": "_V3Dra_orphBadge",
			"orphRow": "_V3Dra_orphRow",
			"ovArrow": "_V3Dra_ovArrow",
			"ovByTag": "_V3Dra_ovByTag",
			"ovFrom": "_V3Dra_ovFrom",
			"ovRow": "_V3Dra_ovRow",
			"owner": "_V3Dra_owner",
			"pageEllipsis": "_V3Dra_pageEllipsis",
			"pageInfo": "_V3Dra_pageInfo",
			"pager": "_V3Dra_pager",
			"pagerPages": "_V3Dra_pagerPages",
			"panelActions": "_V3Dra_panelActions",
			"panelNote": "_V3Dra_panelNote",
			"pct": "_V3Dra_pct",
			"presetList": "_V3Dra_presetList",
			"presetName": "_V3Dra_presetName",
			"presetRow": "_V3Dra_presetRow",
			"progress": "_V3Dra_progress",
			"reassure": "_V3Dra_reassure",
			"reassureOk": "_V3Dra_reassureOk",
			"repoLink": "_V3Dra_repoLink",
			"repoMark": "_V3Dra_repoMark",
			"retryBtn": "_V3Dra_retryBtn",
			"root": "_V3Dra_root",
			"roster": "_V3Dra_roster",
			"rosterAuthor": "_V3Dra_rosterAuthor",
			"rosterMain": "_V3Dra_rosterMain",
			"rosterName": "_V3Dra_rosterName",
			"rosterRow": "_V3Dra_rosterRow",
			"rosterRowOut": "_V3Dra_rosterRowOut",
			"rosterSplit": "_V3Dra_rosterSplit",
			"rosterTag": "_V3Dra_rosterTag",
			"rosterTagDrop": "_V3Dra_rosterTagDrop",
			"rosterTagKeep": "_V3Dra_rosterTagKeep",
			"row1": "_V3Dra_row1",
			"sectAction": "_V3Dra_sectAction",
			"sectionOverview": "_V3Dra_sectionOverview",
			"setActions": "_V3Dra_setActions",
			"setBetaTag": "_V3Dra_setBetaTag",
			"setBody": "_V3Dra_setBody",
			"setCard": "_V3Dra_setCard",
			"setCardOpen": "_V3Dra_setCardOpen",
			"setCheck": "_V3Dra_setCheck",
			"setChevron": "_V3Dra_setChevron",
			"setChevronOpen": "_V3Dra_setChevronOpen",
			"setConfirm": "_V3Dra_setConfirm",
			"setDanger": "_V3Dra_setDanger",
			"setDesc": "_V3Dra_setDesc",
			"setHeader": "_V3Dra_setHeader",
			"setHeadText": "_V3Dra_setHeadText",
			"setHint": "_V3Dra_setHint",
			"setLabel": "_V3Dra_setLabel",
			"setLabelBox": "_V3Dra_setLabelBox",
			"setName": "_V3Dra_setName",
			"setRow": "_V3Dra_setRow",
			"setSeg": "_V3Dra_setSeg",
			"setSegBtn": "_V3Dra_setSegBtn",
			"setSegOn": "_V3Dra_setSegOn",
			"shot": "_V3Dra_shot",
			"shots": "_V3Dra_shots",
			"snapConfirmText": "_V3Dra_snapConfirmText",
			"snapList": "_V3Dra_snapList",
			"snapMeta": "_V3Dra_snapMeta",
			"snapRow": "_V3Dra_snapRow",
			"sp": "_V3Dra_sp",
			"spec": "_V3Dra_spec",
			"specTag": "_V3Dra_specTag",
			"specTagFile": "_V3Dra_specTagFile",
			"specTagGit": "_V3Dra_specTagGit",
			"spin": "_V3Dra_spin",
			"src": "_V3Dra_src",
			"staleAction": "_V3Dra_staleAction",
			"star": "_V3Dra_star",
			"stateDot": "_V3Dra_stateDot",
			"stateTag": "_V3Dra_stateTag",
			"stickyHead": "_V3Dra_stickyHead",
			"sub": "_V3Dra_sub",
			"submitLink": "_V3Dra_submitLink",
			"subTabs": "_V3Dra_subTabs",
			"swatches": "_V3Dra_swatches",
			"switch": "_V3Dra_switch",
			"switchKnob": "_V3Dra_switchKnob",
			"switchMixed": "_V3Dra_switchMixed",
			"switchOn": "_V3Dra_switchOn",
			"tab": "_V3Dra_tab",
			"tabs": "_V3Dra_tabs",
			"tabSearch": "_V3Dra_tabSearch",
			"tabSearchRow": "_V3Dra_tabSearchRow",
			"tag": "_V3Dra_tag",
			"themeActions": "_V3Dra_themeActions",
			"themeCard": "_V3Dra_themeCard",
			"themeCardBody": "_V3Dra_themeCardBody",
			"themeCardFooter": "_V3Dra_themeCardFooter",
			"themeCardHead": "_V3Dra_themeCardHead",
			"themeCover": "_V3Dra_themeCover",
			"themeCoverEmpty": "_V3Dra_themeCoverEmpty",
			"themeDescription": "_V3Dra_themeDescription",
			"themeFullscreenBtn": "_V3Dra_themeFullscreenBtn",
			"themeGallery": "_V3Dra_themeGallery",
			"themeIdentity": "_V3Dra_themeIdentity",
			"themeLifecycle": "_V3Dra_themeLifecycle",
			"themePreviewAction": "_V3Dra_themePreviewAction",
			"themePreviewCount": "_V3Dra_themePreviewCount",
			"themeResultBar": "_V3Dra_themeResultBar",
			"themeSearch": "_V3Dra_themeSearch",
			"themesGrid": "_V3Dra_themesGrid",
			"themeStatus": "_V3Dra_themeStatus",
			"themeStatusMuted": "_V3Dra_themeStatusMuted",
			"themeToolbar": "_V3Dra_themeToolbar",
			"themeToolbarActions": "_V3Dra_themeToolbarActions",
			"title": "_V3Dra_title",
			"titleRow": "_V3Dra_titleRow",
			"top": "_V3Dra_top",
			"topBtn": "_V3Dra_topBtn",
			"version": "_V3Dra_version",
			"viewBar": "_V3Dra_viewBar",
			"viewBtn": "_V3Dra_viewBtn",
			"viewOn": "_V3Dra_viewOn",
			"warnLine": "_V3Dra_warnLine"
		};
		//#endregion
